...
- **VS Code: comments on code.** Select lines, click the `+` in the gutter or right-click → TaskHunter → Add Comment, and write your note. It stays pinned to the code and goes out with your next message as a context card. Works in diffs too (thanks to @felipegenef).
