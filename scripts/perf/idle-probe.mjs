...
export const IDLE_PROBE_GLOBAL = "__taskhunterIdleProbe"

const probeFactory = function installTaskhunterIdleProbe(globalName, stackCaptureBudget) {
  ...
  const siteFromStack = (kind) => {
    ...
    for (const line of lines) {
      ...
      if (line.includes("installTaskhunterIdleProbe")) continue
