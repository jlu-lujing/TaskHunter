...
Start TaskHunter locally, then run:
...
measure, then return to the terminal and press Enter. Use TaskHunter normally
...
bun run profile:browser -- --output /tmp/taskhunter-profile
