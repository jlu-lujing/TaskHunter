 ...
 * it as `window.__TASKHUNTER_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __TASKHUNTER_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__TASKHUNTER_DESKTOP_BOOT_OUTCOME__;
