...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.activityDefault',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.weekStartsOn',
    keywords: ['calendar', 'monday', 'sunday'],
  },
  {
    id: 'appearance.light-theme',
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.dockBadge',
    descriptionKey: 'settings.taskhunter.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in TaskHunterVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.alwaysShowScrollbars',
    descriptionKey: 'settings.taskhunter.visual.field.alwaysShowScrollbarsHint',
    keywords: ['scrollbar', 'scrollbars', 'scroll', 'mouse', 'wheel', 'accessibility', 'always visible'],
  },
  {
    id: 'appearance.pwa-install-name',
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.installAppName',
    descriptionKey: 'settings.taskhunter.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.installOrientation',
    descriptionKey: 'settings.taskhunter.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.taskhunter.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.terminal-shell',
    page: 'general',
    titleKey: 'settings.taskhunter.visual.field.terminalShell',
    descriptionKey: 'settings.taskhunter.visual.field.terminalShellHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.taskhunter.visual.field.inputBarOffset',
    descriptionKey: 'settings.taskhunter.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.taskhunter.visual.field.autoSaveEnabledInfo',
    keywords: ['editor', 'autosave', 'auto-save', 'files', 'save'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'general',
    titleKey: 'settings.taskhunter.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.session-tabs',
    page: 'general',
    titleKey: 'settings.taskhunter.visual.field.sessionTabsGroup',
    descriptionKey: 'settings.taskhunter.visual.field.sessionTabsInfo',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.taskhunter.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.taskhunter.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'general.app-links',
    page: 'general',
    titleKey: 'settings.taskhunter.appLinks.title',
    descriptionKey: 'settings.taskhunter.appLinks.info',
    keywords: ['security', 'app link', 'deep link', 'scheme', 'protocol', 'obsidian', 'notion'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.taskhunter.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.streaming',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.streaming',
    keywords: ['stream', 'scroll'],
  },
  {
    id: 'chat.streaming-auto-follow',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.streamingAutoFollow',
    descriptionKey: 'settings.taskhunter.visual.field.streamingAutoFollowInfo',
    keywords: ['autoscroll', 'auto-scroll', 'follow', 'stick to bottom', 'streaming'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.taskhunter.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.followUpBehavior',
    descriptionKey: 'settings.taskhunter.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.input-history-scope',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.inputHistoryScope',
    descriptionKey: 'settings.taskhunter.visual.field.inputHistoryScopeDescription',
    keywords: ['input history', 'composer history', 'global', 'session', 'reuse'],
  },
  {
    id: 'chat.input-history-limit',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.inputHistoryLimit',
    descriptionKey: 'settings.taskhunter.visual.field.inputHistoryLimitDescription',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck', 'paste'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.largeTextPaste',
    descriptionKey: 'settings.taskhunter.visual.field.largeTextPasteHint',
    keywords: ['paste', 'clipboard', 'attachment', 'large', 'text', 'file'],
  },
  {
    id: 'chat.enter-to-send',
    page: 'chat',
    titleKey: 'settings.taskhunter.visual.field.enterToSend',
    descriptionKey: 'settings.taskhunter.visual.field.enterToSendHint',
    keywords: ['enter', 'shift enter', 'ctrl enter', 'cmd enter', 'mod enter', 'send', 'newline'],
  },
  {
    id: 'sessions.default-model',
    page: 'sessions',
    titleKey: 'settings.taskhunter.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.taskhunter.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.taskhunter.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.taskhunter.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.taskhunter.defaults.smallModel.title',
    descriptionKey: 'settings.taskhunter.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.taskhunter.defaults.walkthroughModel.title',
    descriptionKey: 'settings.taskhunter.defaults.walkthroughModel.description',
    keywords: ['walkthrough', 'diff', 'review', 'changes', 'structured output', 'model', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.taskhunter.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.taskhunter.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-only-archived',
    page: 'sessions',
    titleKey: 'settings.taskhunter.sessionRetention.field.onlyArchived',
    descriptionKey: 'settings.taskhunter.sessionRetention.field.onlyArchivedDescription',
    keywords: ['archive', 'archived', 'only', 'delete', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.taskhunter.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.taskhunter.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.taskhunter.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.taskhunter.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.taskhunter.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.taskhunter.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.taskhunter.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.taskhunter.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.taskhunter.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.desktopPassword.field.password',
    descriptionKey: 'settings.taskhunter.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.taskhunter.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.taskhunter.tools.field.agentControlTool',
    descriptionKey: 'settings.taskhunter.tools.field.agentControlToolInfo',
    keywords: ['agent', 'tool', 'orchestration', 'taskhunter', 'sessions', 'schedule', 'control'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-web-tool',
    page: 'general',
    titleKey: 'settings.taskhunter.tools.field.agentWebTool',
    descriptionKey: 'settings.taskhunter.tools.field.agentWebToolInfo',
    keywords: ['agent', 'tool', 'web', 'browser', 'page', 'preview', 'taskhunter'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-memory-tool',
    page: 'general',
    titleKey: 'settings.taskhunter.tools.field.agentMemoryTool',
    descriptionKey: 'settings.taskhunter.tools.field.agentMemoryToolInfo',
    keywords: ['agent', 'tool', 'memory', 'remember', 'recall', 'preferences', 'taskhunter'],
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.taskhunter.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.taskhunter.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.taskhunter.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.taskhunter.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    keywords: ['shared', 'team', 'repository', '.taskhunter', 'project.json', 'trust'],
  },
  {
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.taskhunter.keyboardShortcuts.title',
    descriptionKey: 'settings.taskhunter.keyboardShortcuts.tooltip',
  ...
  },
  {
    ...
    descriptionKey: 'settings.taskhunter.engine.section.engineDescription',
    keywords: ['engine', 'builtin', 'opencode cli', 'runtime'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'engine.model',
    page: 'engine',
    titleKey: 'settings.taskhunter.engine.field.model',
    keywords: ['builtin model', 'model ref', 'deepseek', 'opencode-go'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'engine.api-key',
    page: 'engine',
    titleKey: 'settings.taskhunter.engine.field.apiKey',
    descriptionKey: 'settings.taskhunter.engine.section.apiKeyDescription',
    keywords: ['api key', 'go', 'opencode go', 'credential', 'secret'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.taskhunter.tunnel.field.provider',
    descriptionKey: 'settings.taskhunter.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.taskhunter.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.taskhunter.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.taskhunter.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.taskhunter.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.taskhunter.tunnel.field.configurationFile',
    descriptionKey: 'settings.taskhunter.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.taskhunter.tunnel.actions.startTunnel',
    descriptionKey: 'settings.taskhunter.tunnel.note.connectLinksOneTime',
