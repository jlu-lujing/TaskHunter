/**
 * The settings registry: one table that names every TaskHunter setting, who
...
export const SETTINGS_REGISTRY = {
  ...
  engine: field({ scope: 'instance', parse: parseOneOf(['opencode', 'builtin']) }),
  engineModel: field({ scope: 'instance', parse: parseTrimmedStringUpTo(200) }),
  engineProviders: field<Record<string, EngineProviderConfig>>({ scope: 'instance', parse: parseEngineProviders }),
