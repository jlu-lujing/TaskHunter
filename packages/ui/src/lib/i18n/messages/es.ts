...
export const dict: Record<I18nKey, string> = {
  ...
  "board.claim.toast.sendTaskFailed": "Error al enviar la tarea a la sesión",
  "board.claim.toast.startFailed": "Error al iniciar la sesión",
  "board.claim.error.noProject": "Esta tarea necesita un proyecto primero",
  "board.claim.error.noModelSelected": "No hay modelo predeterminado: elígelo en Ajustes",
