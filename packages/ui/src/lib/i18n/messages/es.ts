...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala TaskHunter para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "TaskHunter se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a TaskHunter",
  ...
  "mobile.connect.password.placeholder": "Contraseña de TaskHunter",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de TaskHunter.",
  ...
  "mobile.connect.relay.badge": "a través de TaskHunter Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de TaskHunter.",
  ...
  "board.filter.allProjects": "Todos los proyectos",
  "board.filterProject": "Filtrar por proyecto",
  "board.column.empty": "Sin tareas",
  "board.status.backlog": "Backlog",
  "board.status.planning": "Planificación",
  "board.status.queued": "En cola",
  "board.status.running": "En ejecución",
  "board.status.checking": "Comprobación",
  "board.status.merging": "Fusionando",
  "board.status.inProgress": "En curso",
  "board.status.review": "En revisión",
  "board.status.done": "Hecha",
  "board.status.blocked": "Bloqueado",
  "board.card.sessions": "Sesiones vinculadas",
  "board.card.menu.open": "Detalles de la tarjeta",
  "board.card.menu.edit": "Editar tarjeta",
  "board.card.menu.openSession": "Abrir sesión del worker",
  "board.card.menu.openPr": "Abrir pull request",
  "board.card.menu.initRepo": "Inicializar repositorio Git",
  "board.card.menu.initRepoCreated": "Repositorio Git inicializado",
  "board.card.menu.initRepoAlready": "Ya es un repositorio Git",
  "board.card.menu.initRepoFailed": "Error al inicializar el repositorio Git",
  "board.card.menu.moveToBacklog": "Mover a Backlog",
  "board.card.menu.moveToPlanning": "Mover a Planificación",
  "board.card.menu.deleteFailed": "Error al eliminar la tarjeta",
  "board.card.moveBack": "Una columna atrás",
  "board.card.moveForward": "Una columna adelante",
  "board.dialog.titleCreate": "Nueva tarea",
  "board.dialog.titleEdit": "Editar tarea",
  "board.dialog.field.title": "Título",
  "board.dialog.field.titlePlaceholder": "¿Qué hay que hacer?",
  "board.dialog.field.description": "Descripción",
  "board.dialog.field.descriptionPlaceholder": "Detalles que verá el agente de código",
  "board.dialog.field.project": "Proyecto",
  "board.dialog.field.noProject": "Sin proyecto",
  "board.dialog.field.status": "Estado",
  "board.dialog.field.labels": "Etiquetas",
  "board.dialog.field.labelsPlaceholder": "separadas por comas",
  "board.dialog.create": "Crear",
  "board.dialog.save": "Guardar",
  "board.dialog.delete": "Eliminar",
  "board.dialog.cancel": "Cancelar",
  "board.eval.planTitle": "Plan de lanzamiento",
  "board.eval.running": "Evaluando…",
  "board.eval.failed": "Evaluación fallida",
  "board.eval.retry": "Reevaluar",
  "board.planning.approve": "Aprobar y encolar",
  "board.checking.verify": "Verificando entrega",
  "board.eval.deliverable.pr": "Entrega: PR",
  "board.eval.deliverable.report": "Entrega: informe",
  "board.eval.review.human": "Revisión humana",
  "board.eval.review.green": "Fusión automática con CI en verde",
  "board.settings.action": "Ajustes del tablero",
  "board.settings.title": "Ajustes del tablero",
  "board.settings.model": "Modelo de despacho",
  "board.settings.modelUnset": "Sin modelo predeterminado: las sesiones usan el del selector",
  "board.settings.modelHint": "Se usa en la evaluación y las sesiones del tablero",
  "board.settings.modelClear": "borrar",
  "board.settings.maxConcurrent": "Tareas simultáneas máx.",
  "board.settings.automation": "Automatización",
  "board.settings.automation.plan": "Aprobar antes de iniciar",
  "board.settings.automation.auto": "Iniciar automáticamente tras la evaluación",
  "board.settings.automationHint": "Se aplica a tarjetas que llegan a Listo sin plan propio",
  "board.settings.budgets": "Presupuestos de reintento",
  "board.settings.checkRetries": "Auto-reparación de chequeo",
  "board.settings.mergeRetries": "Rebase de fusión",
  "board.settings.maxAttempts": "Reintentos de despacho",
  "board.review.merge": "Fusionar PR",
  "board.review.accept": "Aceptar y finalizar",
  "board.review.return": "Devolver a Listo",
  "board.queue.queued": "En cola",
  "board.queue.merging": "Fusionando",
  "board.queue.rebasing": "Rebaseando",
  "board.detail.sessions": "Sesiones",
  "board.detail.noSessions": "Aún no hay sesiones",
  "board.detail.open": "Abrir",
  "board.detail.close": "Cerrar",
  "board.detail.edit": "Editar",
  ...
  "sessions.sidebar.footer.actions.aboutTaskHunter": "Acerca de TaskHunter",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de TaskHunter al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está TaskHunter y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja TaskHunter. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a TaskHunter: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en TaskHunter. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "TaskHunter necesita acceso a esta carpeta.",
  ...
  "aboutDialog.taskHunterVersionLabel": "Versión de TaskHunter {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de TaskHunter, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por TaskHunter de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de TaskHunter",
  "header.actions.openAppMenuAria": "Abrir menú de TaskHunter",
  ...
  "chat.textSelection.actions.askTaskHunter": "Por cierto…",
  "chat.textSelection.title.askTaskHunter": "Abrir un borrador BTW con la selección",
  ...
  "projects.sharedTrust.description": "{path} en este repositorio define comandos que se ejecutan en esta máquina. Confía una vez y TaskHunter solo volverá a preguntar cuando cambien.",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres TaskHunter desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear TaskHunter",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de TaskHunter",
  ...
  "multiRun.window.description": "Ventana de TaskHunter Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a TaskHunter",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si TaskHunter no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de TaskHunter. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de TaskHunter y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de TaskHunter para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor TaskHunter o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de TaskHunter. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta TaskHunter pero no es compatible con esta versión de la app. Actualiza TaskHunter en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando TaskHunter. Verifica que la dirección apunte a un servidor TaskHunter.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando TaskHunter. Verifica que la dirección apunte a un servidor TaskHunter.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor TaskHunter en \"{host}\" no es compatible con esta versión de la app. Actualiza TaskHunter en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "TaskHunter no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando TaskHunter...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: taskhunter update",
  "updateDialog.error.signatureRejected": "La actualización descargada fue rechazada: su firma de código no coincide con esta instalación. Normalmente significa que la copia en ejecución no se instaló desde una versión oficial firmada. Instala TaskHunter desde una versión oficial y vuelve a actualizar.",
  "updateDialog.error.updaterDisabled": "El actualizador se detuvo tras una instalación fallida. Cierra TaskHunter, ábrelo de nuevo y reintenta la actualización.",
  "updateDialog.error.restartFailed": "No se pudo reiniciar para instalar la actualización.",
  "updateDialog.error.restartUnavailable": "Instalar la actualización requiere la aplicación de escritorio de TaskHunter.",
  "mobileUpdate.toast.available.title": "Actualización de TaskHunter disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén TaskHunter abierto.",
  ...
  "taskHunterLogo.aria.logo": "Logo de TaskHunter",
