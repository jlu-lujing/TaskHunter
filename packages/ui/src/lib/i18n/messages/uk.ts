...
export const dict: Record<I18nKey, string> = {
  ...
  "board.claim.action": "Почати сесію для цього завдання",
  "board.eval.approve": "Затвердити й запустити",
  ...
  "board.claim.toast.sessionStarted": "Сесію розпочато",
  ...
  "board.claim.toast.startFailed": "Не вдалося розпочати сесію",
