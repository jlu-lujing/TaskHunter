...
export const dict: Record<I18nKey, string> = {
  ...
  "board.claim.toast.sendTaskFailed": "Не вдалося надіслати завдання до сесії",
  "board.claim.toast.startFailed": "Не вдалося розпочати сесію",
  "board.claim.error.noProject": "Спочатку виберіть проєкт для цього завдання",
  "board.claim.error.noModelSelected": "Немає типової моделі — оберіть її в Налаштуваннях",
