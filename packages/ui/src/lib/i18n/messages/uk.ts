...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть TaskHunter для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "TaskHunter встановлено",
  ...
  "mobile.connect.welcome.title": "Підключись до TaskHunter",
  ...
  "mobile.connect.password.placeholder": "Пароль TaskHunter",
  ...
  "mobile.connect.scan.invalid": "Це не QR-код підключення TaskHunter.",
  ...
  "mobile.connect.relay.badge": "через TaskHunter Relay",
  ...
  "mobile.connect.error.unreachable": "Не вдалося достукатись до цього TaskHunter сервера.",
  ...
  "board.title": "Kanban",
  "board.back": "Назад",
  "board.newTask": "Нове завдання",
  "board.loading": "Завантаження дошки…",
  "board.retry": "Повторити",
  "board.filter.allProjects": "Усі проєкти",
  "board.filterProject": "Фільтр за проєктом",
  "board.column.empty": "Немає завдань",
  "board.status.backlog": "Беклог",
  "board.status.planning": "Планування",
  "board.status.queued": "У черзі",
  "board.status.running": "Виконується",
  "board.status.checking": "Перевірка",
  "board.status.merging": "Злиття",
  "board.status.inProgress": "У роботі",
  "board.status.review": "Огляд",
  "board.status.done": "Завершено",
  "board.status.blocked": "Заблоковано",
  "board.card.sessions": "Пов’язані сесії",
  "board.card.menu.open": "Деталі картки",
  "board.card.menu.edit": "Редагувати картку",
  "board.card.menu.openSession": "Відкрити сесію воркера",
  "board.card.menu.openPr": "Відкрити pull request",
  "board.card.menu.initRepo": "Ініціалізувати Git-репозиторий",
  "board.card.menu.initRepoCreated": "Git-репозиторій ініціалізовано",
  "board.card.menu.initRepoAlready": "Це вже Git-репозиторій",
  "board.card.menu.initRepoFailed": "Не вдалося ініціалізувати Git-репозиторій",
  "board.card.menu.moveToBacklog": "Перемістити до Backlog",
  "board.card.menu.moveToPlanning": "Перемістити до Planing",
  "board.card.menu.deleteFailed": "Не вдалося видалити картку",
  "board.card.moveBack": "На колонку назад",
  "board.card.moveForward": "На колонку вперед",
  "board.dialog.titleCreate": "Нове завдання",
  "board.dialog.titleEdit": "Редагувати завдання",
  "board.dialog.field.title": "Заголовок",
  "board.dialog.field.titlePlaceholder": "Що потрібно зробити?",
  "board.dialog.field.description": "Опис",
  "board.dialog.field.descriptionPlaceholder": "Деталі, які бачитиме кодувальний агент",
  "board.dialog.field.project": "Проєкт",
  "board.dialog.field.noProject": "Без проєкту",
  "board.dialog.field.status": "Статус",
  "board.dialog.field.labels": "Мітки",
  "board.dialog.field.labelsPlaceholder": "окремі комами",
  "board.dialog.create": "Створити",
  "board.dialog.save": "Зберегти",
  "board.dialog.delete": "Видалити",
  "board.dialog.cancel": "Скасувати",
  "board.eval.planTitle": "План запуску",
  "board.eval.running": "Оцінювання…",
  "board.eval.failed": "Помилка оцінювання",
  "board.eval.retry": "Оцінити повторно",
  "board.planning.approve": "Затвердити й додати чергу",
  "board.checking.verify": "Перевірка результату",
  "board.eval.deliverable.pr": "Результат: PR",
  "board.eval.deliverable.report": "Результат: звіт",
  "board.eval.review.human": "Огляд людиною",
  "board.eval.review.green": "Автозлиття при зеленому CI",
  "board.settings.action": "Налаштування дошки",
  "board.settings.title": "Налаштування дошки",
  "board.settings.model": "Модель запуску",
  "board.settings.modelUnset": "Немає типової моделі — сесії використовують вибір за замовчуванням",
  "board.settings.modelHint": "Використовується для оцінювання та сесій дошки",
  "board.settings.modelClear": "очистити",
  "board.settings.maxConcurrent": "Макс. паралельних задач",
  "board.settings.automation": "Автоматизація",
  "board.settings.automation.plan": "Схвалювати перед запуском",
  "board.settings.automation.auto": "Запускати автоматично після оцінки",
  "board.settings.automationHint": "Застосовується до карток Ready без власного плану",
  "board.settings.budgets": "Бюджети повторів",
  "board.settings.checkRetries": "Самовідновлення перевірки",
  "board.settings.mergeRetries": "Rebase злиття",
  "board.settings.maxAttempts": "Повтори запуску",
  "board.review.merge": "Злити PR",
  "board.review.accept": "Прийняти й завершити",
  "board.review.return": "Повернути до Ready",
  "board.queue.queued": "У черзі",
  "board.queue.merging": "Злиття",
  "board.queue.rebasing": "Rebase",
  "board.detail.sessions": "Сесії",
  "board.detail.noSessions": "Сесій ще немає",
  "board.detail.open": "Відкрити",
  "board.detail.close": "Закрити",
  "board.detail.edit": "Редагувати",
  ...
  "sessions.sidebar.footer.actions.aboutTaskHunter": "Про TaskHunter",
  ...
  "walkthrough.blocked.serverUnsupported.description": "Сервер TaskHunter, до якого підключено застосунок, не відповів на walkthrough API — отже, він старіший за застосунок. Оновіть сервер до 1.18 або новішої версії та оновіть панель.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} працює на машині, де запущено TaskHunter, і зʼєднання з ним відкрити не вдалося. Нічого зі своєї машини тут не показано.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Вони працюють на машині, де запущено TaskHunter. Щоб їх відкрити, потрібен десктопний застосунок.",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до TaskHunter — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "filesView.editor.binaryFileDescription": "Цей файл є бінарним і його не можна редагувати в TaskHunter. Завантажте його, щоб відкрити в іншій програмі.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "TaskHunter потрібен доступ до цієї папки.",
  ...
  "aboutDialog.taskHunterVersionLabel": "Версія TaskHunter {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан TaskHunter, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації TaskHunter",
  ...
  "header.actions.openAppMenu": "Меню TaskHunter",
  "header.actions.openAppMenuAria": "Відкрити меню TaskHunter",
  ...
  "chat.textSelection.actions.askTaskHunter": "До речі…",
  "chat.textSelection.title.askTaskHunter": "Відкрити BTW-чернетку з виділеним текстом",
  ...
  "projects.sharedTrust.description": "{path} у цьому репозиторії містить команди, які виконуються на цьому комп'ютері. Довірте їх один раз, і TaskHunter запитає знову лише коли вони зміняться.",
  ...
  "sessionAuth.error.networkDescription": "Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте TaskHunter з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати TaskHunter",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими TaskHunter серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску TaskHunter.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до TaskHunter",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо TaskHunter не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце TaskHunter. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в TaskHunter і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера TaskHunter для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер TaskHunter або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією TaskHunter. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з TaskHunter, але несумісний із цією версією застосунку. Оновіть TaskHunter на сервері та повторіть спробу.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює TaskHunter. Перевірте, чи адреса вказує на сервер TaskHunter.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено TaskHunter. Перевірте, чи адреса вказує на сервер TaskHunter.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Потрібне оновлення сервера",
  "onboarding.desktopRecovery.remoteIncompatible.description": "Сервер TaskHunter на \"{host}\" несумісний із цією версією застосунку. Оновіть TaskHunter на сервері та повторіть спробу.",
  ...
  "startup.initRecovery.description": "TaskHunter не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення TaskHunter...",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: taskhunter update",
  "updateDialog.error.signatureRejected": "Завантажене оновлення відхилено: його підпис коду не збігається з цією інсталяцією. Зазвичай це означає, що запущену копію встановлено не з офіційного підписаного релізу. Встановіть TaskHunter з офіційного релізу й оновіться ще раз.",
  "updateDialog.error.updaterDisabled": "Оновлювач зупинився після невдалого встановлення. Закрийте TaskHunter, відкрийте його знову й повторіть оновлення.",
  "updateDialog.error.restartFailed": "Не вдалося перезапустити, щоб встановити оновлення.",
  "updateDialog.error.restartUnavailable": "Щоб встановити оновлення, потрібен застосунок TaskHunter для комп’ютера.",
  "mobileUpdate.toast.available.title": "Доступне оновлення TaskHunter",
  ...
  "opencodeUpdate.toast.upgrading.description": "Залиште TaskHunter відкритим.",
  ...
  "taskHunterLogo.aria.logo": "Логотип TaskHunter",
