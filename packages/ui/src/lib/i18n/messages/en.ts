...
export const dict = {
  ...
  'board.claim.toast.sendTaskFailed': 'Failed to send the task to the session',
  'board.claim.toast.startFailed': 'Failed to start session',
  'board.claim.error.noProject': 'This task needs a project before a session can start',
  'board.claim.error.noModelSelected': 'No default model — pick one in Settings',
