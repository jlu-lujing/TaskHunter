...
export const dict = {
  ...
  'board.claim.action': 'Start a session for this task',
  'board.eval.approve': 'Approve & start',
  ...
  'board.claim.toast.sessionStarted': 'Session started',
  ...
  'board.claim.toast.startFailed': 'Failed to start session',
