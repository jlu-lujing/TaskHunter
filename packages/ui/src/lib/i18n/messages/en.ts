...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install TaskHunter for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'TaskHunter installed',
  ...
  'mobile.connect.welcome.title': 'Connect to TaskHunter',
  ...
  'mobile.connect.password.placeholder': 'TaskHunter password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an TaskHunter connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that TaskHunter server.',
  ...
  'board.filterProject': 'Filter by project',
  'board.column.empty': 'No tasks',
  'board.status.backlog': 'Backlog',
  'board.status.planning': 'Planning',
  'board.status.queued': 'Queued',
  'board.status.running': 'Running',
  'board.status.checking': 'Checking',
  'board.status.merging': 'Merging',
  'board.status.inProgress': 'In progress',
  'board.status.review': 'Review',
  'board.status.done': 'Done',
  'board.status.blocked': 'Blocked',
  'board.card.sessions': 'Linked sessions',
  'board.card.menu.open': 'Card details',
  'board.card.menu.edit': 'Edit card',
  'board.card.menu.openSession': 'Open worker session',
  'board.card.menu.openPr': 'Open pull request',
  'board.card.menu.initRepo': 'Initialize Git repository',
  'board.card.menu.initRepoCreated': 'Git repository initialized',
  'board.card.menu.initRepoAlready': 'Already a git repository',
  'board.card.menu.initRepoFailed': 'Failed to initialize git repository',
  'board.card.menu.moveToBacklog': 'Move to Backlog',
  'board.card.menu.moveToPlanning': 'Move to Planning',
  'board.card.menu.deleteFailed': 'Failed to delete card',
  'board.card.moveBack': 'Move back',
  'board.card.moveForward': 'Move forward',
  'board.dialog.titleCreate': 'New task',
  'board.dialog.titleEdit': 'Edit task',
  'board.dialog.field.title': 'Title',
  'board.dialog.field.titlePlaceholder': 'What needs doing?',
  'board.dialog.field.description': 'Description',
  'board.dialog.field.descriptionPlaceholder': 'Details the coding agent will see',
  'board.dialog.field.project': 'Project',
  'board.dialog.field.noProject': 'No project',
  'board.dialog.field.status': 'Status',
  'board.dialog.field.labels': 'Labels',
  'board.dialog.field.labelsPlaceholder': 'comma, separated',
  'board.dialog.create': 'Create',
  'board.dialog.save': 'Save',
  'board.dialog.delete': 'Delete',
  'board.dialog.cancel': 'Cancel',
  'board.eval.planTitle': 'Launch plan',
  'board.eval.running': 'Evaluating…',
  'board.eval.failed': 'Evaluation failed',
  'board.eval.retry': 'Re-evaluate',
  'board.planning.approve': 'Approve & queue',
  'board.checking.verify': 'Verifying delivery',
  'board.eval.deliverable.pr': 'Deliver: PR',
  'board.eval.deliverable.report': 'Deliver: Report',
  'board.eval.review.human': 'Human review',
  'board.eval.review.green': 'Auto-merge when green',
  'board.settings.action': 'Board settings',
  'board.settings.title': 'Board settings',
  'board.settings.model': 'Dispatch model',
  'board.settings.modelUnset': 'No default model — sessions use the picker default',
  'board.settings.modelHint': 'Used for board evaluation and dispatched sessions',
  'board.settings.modelClear': 'clear',
  'board.settings.maxConcurrent': 'Max concurrent tasks',
  'board.settings.automation': 'Automation',
  'board.settings.automation.plan': 'Approve before start',
  'board.settings.automation.auto': 'Start automatically after evaluation',
  'board.settings.automationHint': 'Applies to cards entering Ready without their own plan',
  'board.settings.budgets': 'Retry budgets',
  'board.settings.checkRetries': 'Check self-heals',
  'board.settings.mergeRetries': 'Merge rebases',
  'board.settings.maxAttempts': 'Dispatch retries',
  'board.review.merge': 'Merge pull request',
  'board.review.accept': 'Accept and finish',
  'board.review.return': 'Return to Ready',
  'board.queue.queued': 'Queued',
  'board.queue.merging': 'Merging',
  'board.queue.rebasing': 'Rebasing',
  'board.detail.sessions': 'Sessions',
  'board.detail.noSessions': 'No sessions yet',
  'board.detail.open': 'Open',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': 'About TaskHunter',
  ...
  'contextRail.surface.graph.description': 'Commit graph and per-commit actions',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The TaskHunter server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine TaskHunter is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting TaskHunter. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to TaskHunter — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in TaskHunter. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes TaskHunter state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate TaskHunter efficiently',
  ...
  'header.actions.openAppMenu': 'TaskHunter menu',
  'header.actions.openAppMenuAria': 'Open TaskHunter menu',
  ...
  'chat.textSelection.actions.askTaskHunter': 'By the way…',
  'chat.textSelection.title.askTaskHunter': 'Open a BTW draft with the selection',
  ...
  'projects.sharedTrust.description': '{path} in this repository defines commands that run on this machine. Trust them once, and TaskHunter asks again only when they change.',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening TaskHunter from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock TaskHunter',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote TaskHunter servers',
  ...
  'multiRun.window.description': 'TaskHunter Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to TaskHunter',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If TaskHunter does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of TaskHunter — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to TaskHunter settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an TaskHunter server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an TaskHunter server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different TaskHunter version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running TaskHunter but is not compatible with this app version. Update TaskHunter on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running TaskHunter. Verify the address points to an TaskHunter server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running TaskHunter. Verify the address points to an TaskHunter server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The TaskHunter server at "{host}" is not compatible with this app version. Update TaskHunter on the server, then try again.',
  ...
  'startup.initRecovery.description': 'TaskHunter could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating TaskHunter...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: taskhunter update',
  'updateDialog.error.signatureRejected': 'The downloaded update was rejected: its code signature does not match this installation. This usually means the running copy was not installed from an official signed release. Install TaskHunter from an official release, then update again.',
  'updateDialog.error.updaterDisabled': 'The updater stopped after a failed install. Quit TaskHunter, open it again, and retry the update.',
  'updateDialog.error.restartFailed': 'Could not restart to install the update.',
  'updateDialog.error.restartUnavailable': 'Installing the update requires the TaskHunter desktop app.',
  'mobileUpdate.toast.available.title': 'TaskHunter update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep TaskHunter open.',
