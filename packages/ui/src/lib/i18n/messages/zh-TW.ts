...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 TaskHunter 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'TaskHunter 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 TaskHunter',
  ...
  'mobile.connect.password.placeholder': 'TaskHunter 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 TaskHunter 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 TaskHunter Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 TaskHunter 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 TaskHunter。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 TaskHunter，但與此應用程式版本不相容。請更新伺服器上的 TaskHunter 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 TaskHunter 伺服器與此應用程式版本不相容。請更新伺服器上的 TaskHunter 後重試。',
  ...
  'sessions.sidebar.header.actions.board': 'Kanban 看板',
  'board.title': '看板',
  'board.back': '返回',
  'board.newTask': '新增任務',
  'board.loading': '載入看板…',
  'board.retry': '重試',
  'board.filter.allProjects': '全部專案',
  'board.filterProject': '依專案篩選',
  'board.column.empty': '尚無任務',
  'board.status.backlog': '待辦',
  'board.status.planning': '規畫',
  'board.status.queued': '待執行',
  'board.status.running': '執行中',
  'board.status.checking': '檢查',
  'board.status.merging': '合併中',
  'board.status.inProgress': '進行中',
  'board.status.review': '評審中',
  'board.status.done': '已完成',
  'board.status.blocked': '已封鎖',
  'board.card.sessions': '關聯工作階段',
  'board.card.menu.open': '卡片詳情',
  'board.card.menu.edit': '編輯卡片',
  'board.card.menu.openSession': '開啟工作工作階段',
  'board.card.menu.openPr': '開啟拉取請求',
  'board.card.menu.initRepo': '初始化 Git 倉庫',
  'board.card.menu.initRepoCreated': 'Git 倉庫已初始化',
  'board.card.menu.initRepoAlready': '已經是 Git 倉庫',
  'board.card.menu.initRepoFailed': '初始化 Git 倉庫失敗',
  'board.card.menu.moveToBacklog': '移動到「待辦」',
  'board.card.menu.moveToPlanning': '移動到「規劃中」',
  'board.card.menu.deleteFailed': '刪除卡片失敗',
  'board.card.moveBack': '後移一欄',
  'board.card.moveForward': '前移一欄',
  'board.dialog.titleCreate': '新增任務',
  'board.dialog.titleEdit': '編輯任務',
  'board.dialog.field.title': '標題',
  'board.dialog.field.titlePlaceholder': '要做什麼？',
  'board.dialog.field.description': '描述',
  'board.dialog.field.descriptionPlaceholder': '編碼 agent 會看到的細節',
  'board.dialog.field.project': '專案',
  'board.dialog.field.noProject': '無專案',
  'board.dialog.field.status': '狀態',
  'board.dialog.field.labels': '標籤',
  'board.dialog.field.labelsPlaceholder': '逗號分隔',
  'board.dialog.create': '建立',
  'board.dialog.save': '儲存',
  'board.dialog.delete': '刪除',
  'board.dialog.cancel': '取消',
  'board.eval.planTitle': '啟動計畫',
  'board.eval.running': '評估中…',
  'board.eval.failed': '評估失敗',
  'board.eval.retry': '重新評估',
  'board.planning.approve': '批准並排隊',
  'board.checking.verify': '檢查交付物',
  'board.eval.deliverable.pr': '交付：PR',
  'board.eval.deliverable.report': '交付：報告',
  'board.eval.review.human': '人工評審',
  'board.eval.review.green': 'CI 通過後自動合併',
  'board.settings.action': '看板設定',
  'board.settings.title': '看板設定',
  'board.settings.model': '排程模型',
  'board.settings.modelUnset': '未設定預設模型——工作階段使用選擇器預設值',
  'board.settings.modelHint': '用於看板評估與開始工作會話',
  'board.settings.modelClear': '清除',
  'board.settings.maxConcurrent': '最大平行任務數',
  'board.settings.automation': '自動化',
  'board.settings.automation.plan': '開始前需核准',
  'board.settings.automation.auto': '評估通過後自動開始',
  'board.settings.automationHint': '適用於進入 Ready 且沒有個別啟動計畫的卡片',
  'board.settings.budgets': '重試預算',
  'board.settings.checkRetries': '檢查自愈',
  'board.settings.mergeRetries': '合併變基',
  'board.settings.maxAttempts': '派發重試',
  'board.review.merge': '合併 PR',
  'board.review.accept': '驗收完成',
  'board.review.return': '退回 Ready',
  'board.queue.queued': '排隊中',
  'board.queue.merging': '合併中',
  'board.queue.rebasing': '變基中',
  'board.detail.sessions': '工作階段',
  'board.detail.noSessions': '尚無工作階段',
  'board.detail.open': '開啟',
  'board.detail.close': '關閉',
  'board.detail.edit': '編輯',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': '關於 TaskHunter',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 TaskHunter 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 TaskHunter 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 TaskHunter 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 TaskHunter 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 TaskHunter 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter 需要存取此資料夾。',
  ...
  'aboutDialog.taskHunterVersionLabel': 'TaskHunter 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 TaskHunter 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 TaskHunter',
  ...
  'header.actions.openAppMenu': 'TaskHunter 選單',
  'header.actions.openAppMenuAria': '開啟 TaskHunter 選單',
  ...
  'chat.textSelection.actions.askTaskHunter': '順便問一下…',
  'chat.textSelection.title.askTaskHunter': '用所選文字開啟 BTW 草稿',
  ...
  'projects.sharedTrust.description': '此儲存庫中的 {path} 定義了會在本機執行的命令。信任一次後，只有當命令變更時 TaskHunter 才會再次詢問。',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 TaskHunter，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 TaskHunter',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 TaskHunter 伺服器之間切換',
  ...
  'multiRun.window.description': 'TaskHunter 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 TaskHunter',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 TaskHunter 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 TaskHunter 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 TaskHunter 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 TaskHunter 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 TaskHunter 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 TaskHunter。請確認位址是否指向 TaskHunter 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 TaskHunter。請確認位址是否指向 TaskHunter 伺服器。',
  ...
  'startup.initRecovery.description': 'TaskHunter 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 TaskHunter...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：taskhunter update',
  'updateDialog.error.signatureRejected': '下載的更新遭到拒絕：其程式碼簽章與目前的安裝不符。這通常表示執行中的副本不是從官方簽章版本安裝的。請從官方版本安裝 TaskHunter，再重新更新。',
  'updateDialog.error.updaterDisabled': '一次安裝失敗後，更新程式已停止。請結束 TaskHunter，重新開啟後再試一次更新。',
  'updateDialog.error.restartFailed': '無法重新啟動以安裝更新。',
  'updateDialog.error.restartUnavailable': '安裝更新需要 TaskHunter 桌面應用程式。',
  'mobileUpdate.toast.available.title': 'TaskHunter 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 TaskHunter 開啟。',
  ...
  'taskHunterLogo.aria.logo': 'TaskHunter 標誌',
