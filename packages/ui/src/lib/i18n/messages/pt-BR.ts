...
export const dict: Record<I18nKey, string> = {
  ...
  "board.claim.toast.sendTaskFailed": "Falha ao enviar a tarefa para a sessão",
  "board.claim.toast.startFailed": "Falha ao iniciar a sessão",
  "board.claim.error.noProject": "Esta tarefa precisa primeiro de um projeto",
  "board.claim.error.noModelSelected": "Nenhum modelo padrão disponível — escolha um nas Configurações",
