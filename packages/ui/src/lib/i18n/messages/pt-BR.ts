...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o TaskHunter para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "TaskHunter instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao TaskHunter",
  ...
  "mobile.connect.password.placeholder": "Senha do TaskHunter",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do TaskHunter.",
  ...
  "mobile.connect.relay.badge": "via TaskHunter Relay",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor TaskHunter.",
  ...
  "board.filter.allProjects": "Todos os projetos",
  "board.filterProject": "Filtrar por projeto",
  "board.column.empty": "Sem tarefas",
  "board.status.backlog": "Backlog",
  "board.status.planning": "Planejamento",
  "board.status.queued": "Na fila",
  "board.status.running": "Executando",
  "board.status.checking": "Verificação",
  "board.status.merging": "Mesclando",
  "board.status.inProgress": "Em andamento",
  "board.status.review": "Em revisão",
  "board.status.done": "Concluída",
  "board.status.blocked": "Bloqueado",
  "board.card.sessions": "Sessões vinculadas",
  "board.card.menu.open": "Detalhes do cartão",
  "board.card.menu.edit": "Editar cartão",
  "board.card.menu.openSession": "Abrir sessão do worker",
  "board.card.menu.openPr": "Abrir pull request",
  "board.card.menu.initRepo": "Inicializar repositório Git",
  "board.card.menu.initRepoCreated": "Repositório Git inicializado",
  "board.card.menu.initRepoAlready": "Já é um repositório Git",
  "board.card.menu.initRepoFailed": "Falha ao inicializar o repositório Git",
  "board.card.menu.moveToBacklog": "Mover para Backlog",
  "board.card.menu.moveToPlanning": "Mover para Planejamento",
  "board.card.menu.deleteFailed": "Falha ao excluir o cartão",
  "board.card.moveBack": "Uma coluna para trás",
  "board.card.moveForward": "Uma coluna para frente",
  "board.dialog.titleCreate": "Nova tarefa",
  "board.dialog.titleEdit": "Editar tarefa",
  "board.dialog.field.title": "Título",
  "board.dialog.field.titlePlaceholder": "O que precisa ser feito?",
  "board.dialog.field.description": "Descrição",
  "board.dialog.field.descriptionPlaceholder": "Detalhes que o agente de código verá",
  "board.dialog.field.project": "Projeto",
  "board.dialog.field.noProject": "Sem projeto",
  "board.dialog.field.status": "Status",
  "board.dialog.field.labels": "Tags",
  "board.dialog.field.labelsPlaceholder": "separadas por vírgula",
  "board.dialog.create": "Criar",
  "board.dialog.save": "Salvar",
  "board.dialog.delete": "Excluir",
  "board.dialog.cancel": "Cancelar",
  "board.eval.planTitle": "Plano de execução",
  "board.eval.running": "Avaliando…",
  "board.eval.failed": "Falha na avaliação",
  "board.eval.retry": "Avaliar novamente",
  "board.planning.approve": "Aprovar e enfileirar",
  "board.checking.verify": "Verificando entrega",
  "board.eval.deliverable.pr": "Entrega: PR",
  "board.eval.deliverable.report": "Entrega: relatório",
  "board.eval.review.human": "Revisão humana",
  "board.eval.review.green": "Mesclar automático com CI verde",
  "board.settings.action": "Configurações do quadro",
  "board.settings.title": "Configurações do quadro",
  "board.settings.model": "Modelo de despacho",
  "board.settings.modelUnset": "Sem modelo padrão — sessões usam o padrão do seletor",
  "board.settings.modelHint": "Usado na avaliação e nas sessões do quadro",
  "board.settings.modelClear": "limpar",
  "board.settings.maxConcurrent": "Máx. de tarefas simultâneas",
  "board.settings.automation": "Automação",
  "board.settings.automation.plan": "Aprovar antes de iniciar",
  "board.settings.automation.auto": "Iniciar automaticamente após avaliação",
  "board.settings.automationHint": "Vale para cartões que entram em Pronto sem plano próprio",
  "board.settings.budgets": "Orçamentos de tentativa",
  "board.settings.checkRetries": "Auto-reparo da verificação",
  "board.settings.mergeRetries": "Rebase da mesclagem",
  "board.settings.maxAttempts": "Novas tentativas de despacho",
  "board.review.merge": "Mesclar PR",
  "board.review.accept": "Aceitar e concluir",
  "board.review.return": "Devolver para Pronto",
  "board.queue.queued": "Na fila",
  "board.queue.merging": "Mesclando",
  "board.queue.rebasing": "Rebaseando",
  "board.detail.sessions": "Sessões",
  "board.detail.noSessions": "Nenhuma sessão ainda",
  "board.detail.open": "Abrir",
  "board.detail.close": "Fechar",
  ...
  "sessions.sidebar.footer.actions.aboutTaskHunter": "Sobre o TaskHunter",
  ...
  "contextRail.surface.graph.description": "Grafo de commits e ações por commit",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor TaskHunter ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o TaskHunter está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o TaskHunter. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao TaskHunter — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no TaskHunter. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "TaskHunter precisa acessar esta pasta.",
  ...
  "aboutDialog.taskHunterVersionLabel": "Versão do TaskHunter {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do TaskHunter, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo TaskHunter com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do TaskHunter",
  "header.actions.openAppMenuAria": "Abrir menu do TaskHunter",
  ...
  'chat.textSelection.actions.askTaskHunter': 'A propósito…',
  'chat.textSelection.title.askTaskHunter': 'Abrir um rascunho BTW com a seleção',
  ...
  "projects.sharedTrust.description": "{path} neste repositório define comandos que rodam nesta máquina. Confie uma vez e o TaskHunter só perguntará de novo quando eles mudarem.",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o TaskHunter de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do TaskHunter",
  ...
  "multiRun.window.description": "Janela do TaskHunter Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao TaskHunter",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o TaskHunter não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do TaskHunter. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do TaskHunter e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do TaskHunter para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor TaskHunter ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do TaskHunter. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando TaskHunter, mas não é compatível com esta versão do app. Atualize o TaskHunter no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando TaskHunter. Verifique se o endereço aponta para um servidor TaskHunter.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando TaskHunter. Verifique se o endereço aponta para um servidor TaskHunter.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor TaskHunter em \"{host}\" não é compatível com esta versão do app. Atualize o TaskHunter no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O TaskHunter não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando TaskHunter...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: taskhunter update",
  "updateDialog.error.signatureRejected": "A atualização baixada foi rejeitada: a assinatura de código não corresponde a esta instalação. Isso costuma significar que a cópia em execução não foi instalada a partir de uma versão oficial assinada. Instale o TaskHunter a partir de uma versão oficial e atualize novamente.",
  "updateDialog.error.updaterDisabled": "O atualizador parou após uma instalação com falha. Feche o TaskHunter, abra-o de novo e tente atualizar outra vez.",
  "updateDialog.error.restartFailed": "Não foi possível reiniciar para instalar a atualização.",
  "updateDialog.error.restartUnavailable": "Instalar a atualização exige o aplicativo de desktop do TaskHunter.",
  "mobileUpdate.toast.available.title": "Atualização do TaskHunter disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o TaskHunter aberto.",
  ...
  "taskHunterLogo.aria.logo": "Logo do TaskHunter",
