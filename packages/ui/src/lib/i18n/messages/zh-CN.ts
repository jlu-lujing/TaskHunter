...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 TaskHunter 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'TaskHunter 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 TaskHunter',
  ...
  'mobile.connect.password.placeholder': 'TaskHunter 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 TaskHunter 服务器。',
  ...
  'board.filterProject': '按项目筛选',
  'board.column.empty': '暂无任务',
  'board.status.backlog': '待办',
  'board.status.planning': '规划',
  'board.status.queued': '待执行',
  'board.status.running': '执行中',
  'board.status.checking': '检查',
  'board.status.merging': '合并中',
  'board.status.inProgress': '进行中',
  'board.status.review': '评审中',
  'board.status.done': '已完成',
  'board.status.blocked': '已阻塞',
  'board.card.sessions': '关联会话',
  'board.card.menu.open': '卡片详情',
  'board.card.menu.edit': '编辑卡片',
  'board.card.menu.openSession': '打开工作会话',
  'board.card.menu.openPr': '打开拉取请求',
  'board.card.menu.initRepo': '初始化 Git 仓库',
  'board.card.menu.initRepoCreated': 'Git 仓库已初始化',
  'board.card.menu.initRepoAlready': '已经是 Git 仓库',
  'board.card.menu.initRepoFailed': '初始化 Git 仓库失败',
  'board.card.menu.moveToBacklog': '移动到“待办”',
  'board.card.menu.moveToPlanning': '移动到“规划中”',
  'board.card.menu.deleteFailed': '删除卡片失败',
  'board.card.moveBack': '后移一列',
  'board.card.moveForward': '前移一列',
  'board.dialog.titleCreate': '新建任务',
  'board.dialog.titleEdit': '编辑任务',
  'board.dialog.field.title': '标题',
  'board.dialog.field.titlePlaceholder': '要做什么？',
  'board.dialog.field.description': '描述',
  'board.dialog.field.descriptionPlaceholder': '编码 agent 会看到的细节',
  'board.dialog.field.project': '项目',
  'board.dialog.field.noProject': '无项目',
  'board.dialog.field.status': '状态',
  'board.dialog.field.labels': '标签',
  'board.dialog.field.labelsPlaceholder': '逗号分隔',
  'board.dialog.create': '创建',
  'board.dialog.save': '保存',
  'board.dialog.delete': '删除',
  'board.dialog.cancel': '取消',
  'board.eval.planTitle': '启动计划',
  'board.eval.running': '评估中…',
  'board.eval.failed': '评估失败',
  'board.eval.retry': '重新评估',
  'board.planning.approve': '批准并排队',
  'board.checking.verify': '检查交付物',
  'board.eval.deliverable.pr': '交付：PR',
  'board.eval.deliverable.report': '交付：报告',
  'board.eval.review.human': '人工评审',
  'board.eval.review.green': 'CI 绿后自动合并',
  'board.settings.action': '看板设置',
  'board.settings.title': '看板设置',
  'board.settings.model': '调度模型',
  'board.settings.modelUnset': '未设置默认模型——会话使用选择器默认值',
  'board.settings.modelHint': '用于看板评估和开工会话',
  'board.settings.modelClear': '清除',
  'board.settings.maxConcurrent': '最大并行任务数',
  'board.settings.automation': '自动化',
  'board.settings.automation.plan': '开工前需批准',
  'board.settings.automation.auto': '评估通过后自动开工',
  'board.settings.automationHint': '适用于进入 Ready 且没有独立启动计划的卡片',
  'board.settings.budgets': '重试预算',
  'board.settings.checkRetries': '检查自愈',
  'board.settings.mergeRetries': '合并变基',
  'board.settings.maxAttempts': '派发重试',
  'board.review.merge': '合并 PR',
  'board.review.accept': '验收完成',
  'board.review.return': '退回 Ready',
  'board.queue.queued': '排队中',
  'board.queue.merging': '合并中',
  'board.queue.rebasing': '变基中',
  'board.detail.sessions': '会话',
  'board.detail.noSessions': '还没有会话',
  'board.detail.open': '打开',
  'board.detail.close': '关闭',
  'board.detail.edit': '编辑',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': '关于 TaskHunter',
  ...
  'contextRail.surface.graph.description': '提交图谱与单条提交的常用操作',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 TaskHunter 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 运行在 TaskHunter 所在的机器上，无法与其建立连接。这里不会显示你本机上的任何内容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 TaskHunter 的那台机器上。要打开它们需要桌面应用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 TaskHunter 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 TaskHunter 中编辑。请下载后使用其他应用打开。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter 需要访问此文件夹。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 TaskHunter 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 TaskHunter',
  ...
  'header.actions.openAppMenu': 'TaskHunter 菜单',
  'header.actions.openAppMenuAria': '打开 TaskHunter 菜单',
  ...
  'chat.textSelection.actions.askTaskHunter': '顺便问一下…',
  'chat.textSelection.title.askTaskHunter': '用所选文本打开 BTW 草稿',
  ...
  'projects.sharedTrust.description': '此仓库中的 {path} 定义了会在本机运行的命令。信任一次后，只有当命令变更时 TaskHunter 才会再次询问。',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 TaskHunter，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 TaskHunter',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 TaskHunter 服务器之间切换',
  ...
  'multiRun.window.description': 'TaskHunter 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 TaskHunter',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 TaskHunter 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 TaskHunter 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 TaskHunter 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 TaskHunter 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 TaskHunter 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 TaskHunter。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 TaskHunter，但与此应用版本不兼容。请更新服务器上的 TaskHunter 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 TaskHunter。请确认地址是否指向 TaskHunter 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 TaskHunter。请确认地址是否指向 TaskHunter 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 TaskHunter 服务器与此应用版本不兼容。请更新服务器上的 TaskHunter 后重试。',
  ...
  'startup.initRecovery.description': 'TaskHunter 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：taskhunter update',
  'updateDialog.error.signatureRejected': '下载的更新被拒绝：其代码签名与当前安装不匹配。这通常说明正在运行的副本不是从官方签名版本安装的。请从官方版本安装 TaskHunter，然后再次更新。',
  'updateDialog.error.updaterDisabled': '一次安装失败后，更新程序已停止。请退出 TaskHunter，重新打开后再试一次更新。',
  'updateDialog.error.restartFailed': '无法重启以安装更新。',
  'updateDialog.error.restartUnavailable': '安装更新需要 TaskHunter 桌面应用。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 TaskHunter 打开。',
  ...
  'taskHunterLogo.aria.logo': 'TaskHunter 标志',
