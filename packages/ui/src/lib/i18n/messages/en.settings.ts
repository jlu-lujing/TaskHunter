...
export const settingsDict = {
  'settings.taskhunter.visual.field.alwaysShowScrollbars': 'Always show scrollbars',
  'settings.taskhunter.visual.field.alwaysShowScrollbarsHint': 'Keep scrollbars visible even when the pointer is outside the scrollable area. Applies on this device only.',
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. TaskHunter never scans browser cookie storage.',
  ...
  'settings.window.description': 'TaskHunter settings window.',
  ...
  'settings.page.appearance.description': 'Customize how TaskHunter looks and feels.',
  ...
  'settings.page.engine.description': 'Choose the runtime that powers sessions and set its model and credentials.',
  'settings.taskhunter.engine.section.engine': 'Engine',
  'settings.taskhunter.engine.section.engineDescription': 'New sessions use the selected engine. Existing sessions keep theirs.',
  'settings.taskhunter.engine.section.apiKey': 'OpenCode Go API key',
  'settings.taskhunter.engine.section.apiKeyDescription': 'The builtin engine needs this key. TaskHunter stores it server-side, never in browser storage.',
  'settings.taskhunter.engine.option.opencode': 'OpenCode CLI',
  'settings.taskhunter.engine.option.builtin': 'Builtin',
  'settings.taskhunter.engine.field.engine': 'Engine',
  'settings.taskhunter.engine.field.model': 'Builtin model',
  'settings.taskhunter.engine.field.modelHint': 'A model ref such as opencode-go/deepseek-v4-flash.',
  'settings.taskhunter.engine.field.apiKey': 'API key',
  'settings.taskhunter.engine.apiKey.configured': 'Configured',
  'settings.taskhunter.engine.apiKey.missing': 'Not configured',
  'settings.taskhunter.engine.apiKey.replacePlaceholder': 'Replace key',
  'settings.taskhunter.engine.actions.save': 'Save',
  'settings.taskhunter.engine.actions.clear': 'Clear',
  'settings.taskhunter.engine.toast.saved': 'Engine setting saved',
  'settings.taskhunter.engine.toast.keySaved': 'API key saved',
  'settings.taskhunter.engine.toast.keyCleared': 'API key cleared',
  'settings.taskhunter.engine.toast.saveFailed': 'Could not save. Try again.',
  'settings.taskhunter.engine.section.providers': 'Custom providers',
  'settings.taskhunter.engine.section.providersDescription': 'Point the builtin engine at your own OpenAI-compatible or Anthropic endpoint.',
  'settings.taskhunter.engine.field.providerId': 'Provider id',
  'settings.taskhunter.engine.field.providerIdHint': 'Lowercase, starts with x-, like x-my-provider. Model refs look like x-my-provider/model.',
  'settings.taskhunter.engine.field.providerEndpoint': 'Endpoint',
  'settings.taskhunter.engine.field.providerEndpointHint': 'The full URL the engine posts to for each request.',
  'settings.taskhunter.engine.field.providerFormat': 'Wire format',
  'settings.taskhunter.engine.field.providerFormatHint': 'How requests are encoded: OpenAI Chat Completions, Anthropic Messages, or OpenAI Responses.',
  'settings.taskhunter.engine.field.providerKey': 'API key',
  'settings.taskhunter.engine.field.providerKeyHint': 'Sent as a bearer token. Stored on the server, never in browser storage.',
  'settings.taskhunter.engine.actions.addProvider': 'Add provider',
  'settings.taskhunter.engine.actions.addAnother': 'Add another',
  'settings.taskhunter.engine.actions.remove': 'Remove',
  'settings.taskhunter.engine.actions.cancel': 'Cancel',
  'settings.taskhunter.engine.toast.providerAdded': 'Provider added',
  'settings.taskhunter.engine.toast.providerDeleted': 'Provider removed',
  'settings.taskhunter.engine.toast.providerAddFailed': 'Could not add the provider. Check the id and endpoint.',
  ...
  'settings.taskhunter.tunnel.title': 'External Tunnel',
  'settings.taskhunter.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.taskhunter.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.taskhunter.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.taskhunter.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.taskhunter.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.taskhunter.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.taskhunter.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.taskhunter.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.taskhunter.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.taskhunter.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.taskhunter.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.taskhunter.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.taskhunter.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.taskhunter.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.taskhunter.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.taskhunter.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.taskhunter.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.taskhunter.tunnel.field.provider': 'Provider',
  'settings.taskhunter.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.taskhunter.tunnel.field.tunnelType': 'Tunnel type',
  'settings.taskhunter.tunnel.field.connectLinkTtl': 'Connect link TTL',
  ...
  'settings.taskhunter.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.taskhunter.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.taskhunter.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.taskhunter.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.taskhunter.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.taskhunter.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.taskhunter.tunnel.field.configurationFile': 'Configuration file',
  'settings.taskhunter.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.taskhunter.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.taskhunter.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.taskhunter.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.taskhunter.tunnel.field.connectLink': 'Connect link',
  'settings.taskhunter.tunnel.field.expires': 'Expires',
  'settings.taskhunter.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.taskhunter.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.taskhunter.tunnel.actions.saveToken': 'Save token',
  'settings.taskhunter.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.taskhunter.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.taskhunter.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.taskhunter.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.taskhunter.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.taskhunter.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.taskhunter.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.taskhunter.tunnel.actions.stopping': 'Stopping...',
  'settings.taskhunter.tunnel.actions.newConnectLink': 'New connect link',
  'settings.taskhunter.tunnel.actions.copied': 'Copied',
  'settings.taskhunter.tunnel.actions.retry': 'Retry',
  'settings.taskhunter.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.taskhunter.tunnel.option.mode.quick.label': 'Quick',
  'settings.taskhunter.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.taskhunter.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.taskhunter.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.taskhunter.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.taskhunter.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.taskhunter.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.taskhunter.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.taskhunter.tunnel.state.loading': 'Loading',
  'settings.taskhunter.tunnel.state.expired': 'Expired',
  'settings.taskhunter.tunnel.state.revoked': 'Revoked',
  'settings.taskhunter.tunnel.state.inactive': 'Inactive',
  'settings.taskhunter.tunnel.state.noExpiry': 'No expiry',
  'settings.taskhunter.tunnel.state.never': 'Never',
  'settings.taskhunter.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.taskhunter.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.taskhunter.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.taskhunter.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.taskhunter.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.taskhunter.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/taskhunter/cloudflare-managed-remote-tunnels.json.',
  'settings.taskhunter.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.taskhunter.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.taskhunter.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.taskhunter.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.taskhunter.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.taskhunter.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.taskhunter.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.taskhunter.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.taskhunter.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.taskhunter.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.taskhunter.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.taskhunter.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.taskhunter.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.taskhunter.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.taskhunter.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.taskhunter.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.taskhunter.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.taskhunter.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.taskhunter.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.taskhunter.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.taskhunter.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.taskhunter.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.taskhunter.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.taskhunter.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.taskhunter.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.taskhunter.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.magicPrompts.sidebar.item.boardEvaluate': 'Launch Evaluation',
  'settings.magicPrompts.sidebar.item.boardDispatchPr': 'PR Dispatch',
  'settings.magicPrompts.sidebar.item.boardDispatchReport': 'Report Dispatch',
  'settings.magicPrompts.sidebar.item.boardCheckReport': 'Report Check',
  'settings.magicPrompts.sidebar.item.boardCheckPr': 'PR Check',
  ...
  'settings.remoteInstances.direct.title': 'Other TaskHunter servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another TaskHunter server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another TaskHunter server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid TaskHunter connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so TaskHunter Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the TaskHunter app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through TaskHunter Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the TaskHunter app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether TaskHunter should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port TaskHunter uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.taskhunter.appLinks.title': 'Trusted app links',
  'settings.taskhunter.appLinks.info': 'Links listed here open without asking again on this device. Other app links always ask before opening.',
  'settings.taskhunter.appLinks.empty': 'No trusted app links on this device. Choose "Trust and open" when opening a link to add it here.',
  'settings.taskhunter.appLinks.removeAria': 'Remove trusted {scheme} links',
  ...
  'settings.projects.shared.plansDirInfo': 'Where repository plans live, relative to the repository. Empty means .taskhunter/plans. A custom folder such as docs/plans replaces the default entirely: only that folder is read and written. Move existing files yourself when you change it.',
  ...
  'settings.taskhunter.about.title': 'About TaskHunter',
  'settings.taskhunter.about.field.version': 'Version',
  'settings.taskhunter.about.field.openCodeVersion': 'OpenCode version',
  'settings.taskhunter.about.field.instanceUrls': 'Instance URLs',
  'settings.taskhunter.about.field.applicationUrl': 'Application',
  'settings.taskhunter.about.field.tunnelUrl': 'Tunnel',
  'settings.taskhunter.about.state.checking': 'Checking...',
  'settings.taskhunter.about.state.upToDate': 'Up to date',
  'settings.taskhunter.about.state.unknown': 'unknown',
  'settings.taskhunter.about.actions.checkUpdates': 'Check updates',
  'settings.taskhunter.about.actions.update': 'Update',
  'settings.taskhunter.about.actions.updateToVersion': 'Update to {version}',
  'settings.taskhunter.about.actions.checkForUpdates': 'Check for updates',
  'settings.taskhunter.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.behavior.page.section.context': 'Context compaction',
  'settings.behavior.page.context.description': 'What happens when a session nears the model\'s context limit.',
  'settings.behavior.page.context.loadFailed': 'Could not read the current compaction settings. The options are disabled so this page cannot overwrite them by accident.',
  'settings.behavior.page.context.auto.label': 'Auto-compact when context is full',
  'settings.behavior.page.context.auto.aria': 'Enable automatic context compaction',
  'settings.behavior.page.context.auto.info': 'When a conversation reaches the model\'s context limit, OpenCode summarizes older turns so the session can continue. Only applies to models with a known context limit.',
  'settings.behavior.page.context.prune.label': 'Prune old tool output',
  'settings.behavior.page.context.prune.aria': 'Enable pruning of old tool output',
  'settings.behavior.page.context.prune.info': 'Replaces tool results from older turns with a short marker to free up context. Recent output stays intact.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. TaskHunter will scan it for folders containing',
  ...
  'settings.taskhunter.passkeys.field.currentDevice': 'Current device',
  'settings.taskhunter.passkeys.actions.add': 'Add passkey',
  'settings.taskhunter.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.taskhunter.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.taskhunter.passkeys.actions.signingOut': 'Signing out…',
  'settings.taskhunter.passkeys.actions.removing': 'Removing…',
  'settings.taskhunter.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.taskhunter.passkeys.state.loading': 'Loading passkeys…',
  'settings.taskhunter.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.taskhunter.passkeys.item.lastUsed': 'Last used {time}',
  'settings.taskhunter.passkeys.item.added': 'Added {time}',
  'settings.taskhunter.passkeys.time.neverUsed': 'Never used',
  'settings.taskhunter.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.taskhunter.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.taskhunter.passkeys.toast.added': 'Passkey added',
  'settings.taskhunter.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.taskhunter.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.taskhunter.passkeys.toast.removed': 'Passkey removed',
  'settings.taskhunter.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.taskhunter.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.taskhunter.sessionRetention.title': 'Session Retention',
  'settings.taskhunter.sessionRetention.field.onlyArchived': 'Only archived sessions',
  'settings.taskhunter.sessionRetention.field.onlyArchivedDescription': 'Uses Delete and counts the retention period from archiving. Unarchived sessions are kept.',
  'settings.taskhunter.sessionRetention.archivedTooltip': 'Deletes expired archived sessions. Keeps the 5 most recently archived sessions, the open session, running sessions and shared sessions. A parent is kept if deleting it would also delete a protected child.',
  'settings.taskhunter.sessionRetention.tooltip': 'Archives or deletes unarchived sessions based on last activity. Keeps the 5 most recent sessions, the open session, running sessions and shared sessions. Archived sessions are kept. A parent is kept if deleting it would also delete a protected child.',
  'settings.taskhunter.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.taskhunter.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.taskhunter.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.taskhunter.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.taskhunter.sessionRetention.field.days': 'days',
  'settings.taskhunter.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.taskhunter.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.taskhunter.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.taskhunter.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.taskhunter.sessionRetention.action.archive': 'Archive',
  'settings.taskhunter.sessionRetention.action.delete': 'Delete',
  'settings.taskhunter.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.taskhunter.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.taskhunter.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.taskhunter.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.taskhunter.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.taskhunter.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.taskhunter.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.taskhunter.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.taskhunter.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.taskhunter.desktopNetwork.title': 'Desktop Network Access',
  'settings.taskhunter.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.taskhunter.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.taskhunter.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.taskhunter.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.taskhunter.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.taskhunter.desktopNetwork.field.windowControls': 'Window controls',
  'settings.taskhunter.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.taskhunter.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.taskhunter.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.taskhunter.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.taskhunter.desktopNetwork.field.launchAtLoginAria': 'Start TaskHunter at login',
  'settings.taskhunter.desktopNetwork.field.launchAtLogin': 'Start TaskHunter when you log in',
  'settings.taskhunter.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.taskhunter.desktopNetwork.field.macMenuBarAria': 'Show TaskHunter in the macOS menu bar',
  'settings.taskhunter.desktopNetwork.field.macMenuBar': 'Show TaskHunter in the menu bar',
  'settings.taskhunter.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, TaskHunter does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.taskhunter.desktopNetwork.field.minimizeToTrayAria': 'Close TaskHunter to the system tray',
  'settings.taskhunter.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.taskhunter.desktopNetwork.field.minimizeToTrayDescription': 'Keeps TaskHunter running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.taskhunter.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while TaskHunter is running',
  'settings.taskhunter.desktopNetwork.field.keepAwake': 'Keep computer awake while TaskHunter is running',
  'settings.taskhunter.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.taskhunter.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.taskhunter.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.taskhunter.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.taskhunter.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.taskhunter.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.taskhunter.desktopPassword.field.password': 'Desktop UI Password',
  'settings.taskhunter.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.taskhunter.desktopPassword.field.passwordSetPlaceholder': 'Password set. Type a new one to replace it.',
  'settings.taskhunter.desktopPassword.actions.removePassword': 'Remove password',
  'settings.taskhunter.desktopPassword.field.passwordDescription': 'TaskHunter asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.taskhunter.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.taskhunter.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.taskhunter.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.taskhunter.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.taskhunter.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.taskhunter.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.taskhunter.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.taskhunter.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.taskhunter.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.taskhunter.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.taskhunter.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.taskhunter.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.taskhunter.opencodeCli.title': 'OpenCode CLI',
  'settings.taskhunter.tools.title': 'TaskHunter Tools',
  'settings.taskhunter.tools.field.agentControlTool': 'Agent control tool',
  'settings.taskhunter.tools.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.taskhunter.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.taskhunter.tools.field.agentWebTool': 'TaskHunter Web tool',
  'settings.taskhunter.tools.field.agentWebToolAria': 'Enable the TaskHunter Web tool',
  'settings.taskhunter.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in TaskHunter\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.taskhunter.tools.field.agentMemoryTool': 'Agent memory tool',
  'settings.taskhunter.tools.field.agentMemoryToolAria': 'Agent memory tool',
  'settings.taskhunter.tools.field.agentMemoryToolInfo': 'Let agents keep what they learn across sessions, in two stores: what is true about you, and what is true about each project. Sessions are given the stored titles so the agent can read an entry when it is relevant. Turning this off removes the tool, the Memory tab, and the session index. Applies after OpenCode restarts.',
  'settings.taskhunter.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.taskhunter.opencodeCli.tooltipSuffix': 'binary.',
  'settings.taskhunter.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.taskhunter.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.taskhunter.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.taskhunter.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.taskhunter.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.taskhunter.opencodeCli.actions.browse': 'Browse',
  'settings.taskhunter.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.taskhunter.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.taskhunter.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.taskhunter.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.taskhunter.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.taskhunter.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.taskhunter.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.taskhunter.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.taskhunter.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.taskhunter.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.taskhunter.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.taskhunter.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
    'settings.taskhunter.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. You can still save it.',
  'settings.taskhunter.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.taskhunter.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.taskhunter.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.taskhunter.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.taskhunter.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.taskhunter.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.taskhunter.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.taskhunter.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
    'settings.taskhunter.keyboardShortcuts.action.switch_session_tab.label': 'Switch session tab',
  'settings.taskhunter.keyboardShortcuts.action.switch_session_tab.suffix': ' + 1…9',
  'settings.taskhunter.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.taskhunter.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.taskhunter.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.taskhunter.keyboardShortcuts.action.switch_session_previous.label': 'Previous session',
  'settings.taskhunter.keyboardShortcuts.action.switch_session_next.label': 'Next session',
  'settings.taskhunter.keyboardShortcuts.action.rename_current_session.label': 'Rename current session',
  'settings.taskhunter.keyboardShortcuts.action.toggle_permission_auto_accept.label': 'Toggle permission auto-accept',
  'settings.taskhunter.keyboardShortcuts.action.close_session_tab.label': 'Close session tab',
  'settings.taskhunter.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.taskhunter.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.taskhunter.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.taskhunter.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.taskhunter.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.taskhunter.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.taskhunter.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.taskhunter.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.taskhunter.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.taskhunter.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.taskhunter.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.taskhunter.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  'settings.taskhunter.keyboardShortcuts.warning.contextualPrefix': 'This sequence shares a contextual prefix with {action}. That action takes priority while its context is active.',
  'settings.taskhunter.keyboardShortcuts.category.session': 'Session Controls',
  'settings.taskhunter.keyboardShortcuts.category.models': 'Models & Agents',
  'settings.taskhunter.keyboardShortcuts.category.panels': 'Panels & Tools',
  ...
  'settings.taskhunter.keyboardShortcuts.actions.edit': 'Edit',
  'settings.taskhunter.keyboardShortcuts.actions.confirm': 'Confirm',
  'settings.taskhunter.keyboardShortcuts.dialog.title': 'Edit {action}',
  'settings.taskhunter.keyboardShortcuts.dialog.instructions': 'Press up to two key combinations, with at most three keys each. After the first, wait up to 3 seconds for a second combination. Use Confirm to apply or Cancel to discard. Backspace removes the last one.',
  'settings.taskhunter.keyboardShortcuts.dialog.firstChord': 'First combination',
  'settings.taskhunter.keyboardShortcuts.dialog.secondChord': 'Second combination',
  'settings.taskhunter.keyboardShortcuts.dialog.recording': 'Press keys…',
  'settings.taskhunter.keyboardShortcuts.unassigned': 'Unassigned',
  'settings.taskhunter.keyboardShortcuts.error.prefixConflict': 'This conflicts with the sequence used by {action}. Choose a different combination.',
  'settings.taskhunter.keyboardShortcuts.error.exactConflict': 'This combination is already used by {action}.',
  'settings.taskhunter.keyboardShortcuts.error.internalConflict': 'This combination conflicts with a built-in shortcut, which cannot be replaced.',
  'settings.taskhunter.keyboardShortcuts.action.open_draft_project_picker.label': 'Open draft project picker',
  'settings.taskhunter.keyboardShortcuts.action.open_draft_worktree_picker.label': 'Open draft worktree picker',
  'settings.taskhunter.keyboardShortcuts.action.open_session_list.label': 'Open recent sessions',
  'settings.taskhunter.keyboardShortcuts.action.toggle_dictation.label': 'Voice input',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open TaskHunter there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'TaskHunter on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how TaskHunter should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Access from this computer',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'TaskHunter runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote TaskHunter UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How TaskHunter should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode TaskHunter needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this TaskHunter directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote TaskHunter. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote TaskHunter to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote TaskHunter UI. TaskHunter sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the TaskHunter server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingTaskHunter': 'Installing TaskHunter',
  'settings.remoteInstances.page.phase.updatingTaskHunter': 'Updating TaskHunter',
  ...
  'settings.taskhunter.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.taskhunter.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.taskhunter.worktrees.setup.title': 'Setup commands',
  'settings.taskhunter.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.taskhunter.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.taskhunter.worktrees.setup.loading': 'Loading...',
  'settings.taskhunter.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.taskhunter.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.taskhunter.worktrees.setup.addCommand': 'Add command',
  'settings.taskhunter.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.taskhunter.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.taskhunter.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.taskhunter.worktrees.list.title': 'Existing worktrees',
  'settings.taskhunter.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.taskhunter.worktrees.list.loading': 'Loading worktrees...',
  'settings.taskhunter.worktrees.list.empty': 'No worktrees found for this project',
  'settings.taskhunter.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.taskhunter.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by TaskHunter. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.custom.models.contextLimitLabel': 'Context window (tokens)',
  'settings.providers.page.custom.models.contextLimitPlaceholder': 'e.g. 128000',
  'settings.providers.page.custom.models.outputLimitLabel': 'Max output (tokens)',
  'settings.providers.page.custom.models.outputLimitPlaceholder': 'e.g. 16000',
  'settings.providers.page.custom.models.imageInput': 'Accepts image input',
  'settings.providers.page.custom.models.imageInputInfo': 'Lets you attach images in the chat with this model and tells OpenCode to send them.',
  'settings.providers.page.custom.models.thinkingLevelsLabel': 'Thinking levels',
  'settings.providers.page.custom.models.thinkingLevelsPlaceholder': 'low, medium, high',
  'settings.providers.page.custom.models.thinkingLevelsInfo': 'Comma-separated levels this model offers in the thinking picker. OpenCode sends each level as its own request setting when you pick it in chat.',
  ...
  'settings.providers.page.custom.error.limit.format': 'Token limit must be a whole number greater than 0',
  'settings.providers.page.custom.error.thinkingLevels.format': 'Each level may only use lowercase letters, numbers, hyphens, or underscores',
  'settings.providers.page.custom.error.thinkingLevels.anthropic': 'The Anthropic protocol supports only the low, medium, high, and max levels',
  'settings.providers.page.custom.error.limit.pairRequired': 'Set both context and max output tokens',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by TaskHunter.',
  ...
  'settings.taskhunter.defaults.title': 'Session Defaults',
  'settings.taskhunter.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.taskhunter.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.taskhunter.defaults.field.defaultModel': 'Default Model',
  'settings.taskhunter.defaults.field.defaultThinking': 'Default Thinking',
  'settings.taskhunter.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.taskhunter.defaults.field.defaultAgent': 'Default Agent',
  'settings.taskhunter.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.taskhunter.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.taskhunter.defaults.smallModel.title': 'Small Model',
  'settings.taskhunter.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.taskhunter.defaults.smallModel.useDefault': 'Use default small model',
  'settings.taskhunter.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.taskhunter.defaults.smallModel.overrideModel': 'Override model',
  'settings.taskhunter.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  ...
  'settings.taskhunter.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.taskhunter.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.taskhunter.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.taskhunter.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.taskhunter.defaults.option.default': 'Default',
  'settings.taskhunter.defaults.option.defaultLowercase': 'default',
  'settings.taskhunter.git.title': 'Git Preferences',
  'settings.taskhunter.git.changesViewTitle': 'Changes View',
  'settings.taskhunter.git.changesViewAria': 'Git changes view mode',
  'settings.taskhunter.git.option.flatList': 'Flat List',
  'settings.taskhunter.git.option.treeView': 'Tree View',
  'settings.taskhunter.git.optionAria': 'Git changes view mode: {option}',
  'settings.taskhunter.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.taskhunter.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.taskhunter.git.showGitignoredAria': 'Display gitignored files',
  'settings.taskhunter.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize TaskHunter',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if TaskHunter auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from TaskHunter.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the TaskHunter server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the TaskHunter server (Kokoro for English; models for other languages download on first use). No API key needed.',
  ...
  'settings.taskhunter.visual.section.colorMode': 'Color Mode',
  'settings.taskhunter.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.taskhunter.visual.section.localization': 'Localization',
  'settings.taskhunter.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.taskhunter.visual.section.densityAndType': 'Density & type',
  'settings.taskhunter.visual.section.appInstall': 'App install',
  'settings.taskhunter.visual.section.navigation': 'Navigation',
  'settings.taskhunter.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.taskhunter.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.taskhunter.visual.section.chatDisplay': 'Display',
  'settings.taskhunter.visual.section.chatMessageOptions': 'Message options',
  'settings.taskhunter.visual.section.chatFeatures': 'Features',
  'settings.taskhunter.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.taskhunter.visual.section.activityDefault': 'Activity Default',
  'settings.taskhunter.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.taskhunter.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.taskhunter.visual.section.sessionAssistance': 'Session Assistance',
  'settings.taskhunter.visual.section.reasoning': 'Reasoning',
  'settings.taskhunter.visual.section.streaming': 'Streaming',
  'settings.taskhunter.visual.field.streamingAutoFollow': 'Follow new content while streaming',
  'settings.taskhunter.visual.field.streamingAutoFollowAria': 'Automatically follow new content while a response streams',
  'settings.taskhunter.visual.field.streamingAutoFollowInfo': 'While a reply streams in, the view keeps gliding to the newest content. Turn this off to keep the view still and scroll manually; sending a message while scrolled up then also leaves the view where it is.',
  'settings.taskhunter.visual.section.messageAppearance': 'Message Appearance',
  'settings.taskhunter.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.taskhunter.visual.section.composer': 'Composer',
  'settings.taskhunter.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.taskhunter.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.taskhunter.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.taskhunter.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.taskhunter.visual.section.diffLayout': 'Diff Layout',
  'settings.taskhunter.visual.section.diffLayoutAria': 'Diff layout',
  'settings.taskhunter.visual.section.privacy': 'Privacy',
  'settings.taskhunter.visual.field.lightTheme': 'Light Theme',
  'settings.taskhunter.visual.field.darkTheme': 'Dark Theme',
  'settings.taskhunter.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.taskhunter.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.taskhunter.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.taskhunter.visual.field.timeFormat': 'Time Format',
  'settings.taskhunter.visual.field.weekStartsOn': 'Week Starts On',
  'settings.taskhunter.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.taskhunter.visual.field.selectWeekStartAria': 'Select week start',
  'settings.taskhunter.visual.actions.reloadThemes': 'Reload themes',
  'settings.taskhunter.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.taskhunter.visual.field.dockBadge': 'Dock badge',
  'settings.taskhunter.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.taskhunter.visual.actions.saveAndRestart': 'Save & restart',
  'settings.taskhunter.visual.actions.restarting': 'Restarting…',
  'settings.taskhunter.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.taskhunter.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/taskhunter/themes/',
  'settings.taskhunter.visual.field.installAppName': 'Install App Name',
  'settings.taskhunter.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.taskhunter.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.taskhunter.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.taskhunter.visual.field.installOrientation': 'Install Orientation',
  'settings.taskhunter.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.taskhunter.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.taskhunter.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.taskhunter.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.taskhunter.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.taskhunter.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.taskhunter.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.taskhunter.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.taskhunter.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.taskhunter.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.taskhunter.visual.field.interfaceFont': 'Interface Font',
  'settings.taskhunter.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.taskhunter.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.taskhunter.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.taskhunter.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.taskhunter.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.taskhunter.visual.field.terminalShell': 'Terminal Shell',
  'settings.taskhunter.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.taskhunter.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.taskhunter.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.taskhunter.visual.option.terminalShell.auto': 'Auto',
  'settings.taskhunter.visual.field.editorFontSize': 'Editor Font Size',
  'settings.taskhunter.visual.field.codeFont': 'Code Font',
  'settings.taskhunter.visual.field.selectCodeFontAria': 'Select code font',
  'settings.taskhunter.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.taskhunter.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.taskhunter.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.taskhunter.visual.field.spacingDensity': 'Spacing Density',
  'settings.taskhunter.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.taskhunter.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.taskhunter.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.taskhunter.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.taskhunter.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.taskhunter.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.taskhunter.visual.field.sessionTabsGroup': 'Session tabs',
  'settings.taskhunter.visual.field.sessionTabs': 'Show sessions as tabs in the header',
  'settings.taskhunter.visual.field.sessionTabsAria': 'Toggle session tabs in the header',
  'settings.taskhunter.visual.field.sessionTabsInfo': 'Sessions you open line up as tabs in the header. Turning this off restores the plain session title.',
  'settings.taskhunter.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.taskhunter.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.taskhunter.visual.option.fileEditorKeymap.default': 'Default',
  'settings.taskhunter.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.taskhunter.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.taskhunter.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.taskhunter.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.taskhunter.visual.field.bash': 'Bash',
  'settings.taskhunter.visual.field.editTools': 'Edit tools',
  'settings.taskhunter.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  ...
  'settings.taskhunter.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.taskhunter.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.taskhunter.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.taskhunter.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.taskhunter.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.taskhunter.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.taskhunter.visual.goal.sectionTitle': 'Goal',
  'settings.taskhunter.visual.goal.budgetLabel': 'Default token budget',
  'settings.taskhunter.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.taskhunter.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.taskhunter.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.taskhunter.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.taskhunter.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.taskhunter.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.taskhunter.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.taskhunter.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.taskhunter.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.taskhunter.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.taskhunter.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.taskhunter.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.taskhunter.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.taskhunter.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.taskhunter.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.taskhunter.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.taskhunter.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.taskhunter.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.taskhunter.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.taskhunter.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.taskhunter.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.taskhunter.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.taskhunter.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.taskhunter.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.taskhunter.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.taskhunter.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.taskhunter.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.taskhunter.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.taskhunter.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.taskhunter.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.taskhunter.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.taskhunter.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.taskhunter.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.taskhunter.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.taskhunter.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.taskhunter.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.taskhunter.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.taskhunter.visual.field.largeTextPaste': 'Large text paste',
  'settings.taskhunter.visual.field.largeTextPasteHint': 'When pasting more than about 2,000 characters or 25 lines, choose whether to attach the text as a file, paste it inline, or ask each time.',
  'settings.taskhunter.visual.field.largeTextPasteAria': 'Large text paste behavior',
  'settings.taskhunter.visual.field.largeTextPasteOptionAria': 'Large text paste: {option}',
  'settings.taskhunter.visual.option.largeTextPaste.ask.label': 'Ask each time',
  'settings.taskhunter.visual.option.largeTextPaste.attach.label': 'Attach as file',
  'settings.taskhunter.visual.option.largeTextPaste.inline.label': 'Paste inline',
  'settings.taskhunter.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.taskhunter.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.taskhunter.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.taskhunter.visual.option.themeMode.system': 'System',
  'settings.taskhunter.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.taskhunter.visual.option.themeMode.light': 'Light',
  'settings.taskhunter.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.taskhunter.visual.option.themeMode.dark': 'Dark',
  'settings.taskhunter.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.taskhunter.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.taskhunter.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.taskhunter.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.taskhunter.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.taskhunter.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.taskhunter.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.taskhunter.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.taskhunter.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.taskhunter.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.taskhunter.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.taskhunter.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.taskhunter.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.taskhunter.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.taskhunter.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.taskhunter.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.taskhunter.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.taskhunter.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.taskhunter.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.taskhunter.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.taskhunter.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.taskhunter.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.taskhunter.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.taskhunter.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.taskhunter.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'settings.taskhunter.visual.field.enterToSend': 'Send shortcut',
  'settings.taskhunter.visual.field.enterToSendHint': 'Choose the send shortcut for the standard composer. In the expanded composer, Enter always adds a new line and Ctrl/Cmd+Enter sends.',
  'settings.taskhunter.visual.option.enterToSend.enter.label': 'Send with Enter',
  'settings.taskhunter.visual.option.enterToSend.modifier.label': 'Send with Ctrl/Cmd+Enter',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.taskhunter.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.taskhunter.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.taskhunter.visual.option.chatRenderMode.live.label': 'Live',
  'settings.taskhunter.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.taskhunter.visual.option.messageTransport.auto.label': 'Auto',
  'settings.taskhunter.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.taskhunter.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.taskhunter.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.taskhunter.visual.option.messageTransport.sse.label': 'SSE',
  'settings.taskhunter.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.taskhunter.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.taskhunter.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.taskhunter.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.taskhunter.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.taskhunter.visual.option.timeFormat.auto.label': 'Auto',
  'settings.taskhunter.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.taskhunter.visual.option.timeFormat.24h.label': '24-hour',
  'settings.taskhunter.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.taskhunter.visual.option.timeFormat.12h.label': '12-hour',
  'settings.taskhunter.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.taskhunter.visual.option.weekStart.auto.label': 'Auto',
  'settings.taskhunter.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.taskhunter.visual.option.weekStart.monday.label': 'Monday',
  'settings.taskhunter.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.magicPrompts.page.group.boardEvaluate.title': 'Launch Evaluation',
  'settings.magicPrompts.page.group.boardEvaluate.description': 'System prompt used when the board evaluator judges a ready card into a launch plan (deliverable and review mode included).',
  'settings.magicPrompts.page.group.boardDispatchPr.title': 'PR Dispatch',
  'settings.magicPrompts.page.group.boardDispatchPr.description': 'Instruction block appended to a dispatched board task whose deliverable is a pull request. {{goal_definition}} receives the launch plan goal.',
  'settings.magicPrompts.page.group.boardDispatchReport.title': 'Report Dispatch',
  'settings.magicPrompts.page.group.boardDispatchReport.description': 'Instruction block appended to a dispatched board task whose deliverable is a report. {{goal_definition}} receives the launch plan goal.',
  'settings.magicPrompts.page.group.boardCheckReport.title': 'Report Check',
  'settings.magicPrompts.page.group.boardCheckReport.description': 'System prompt the delivery checker uses to judge a report deliverable against the card goal.',
  'settings.magicPrompts.page.group.boardCheckPr.title': 'PR Check',
  'settings.magicPrompts.page.group.boardCheckPr.description': 'System prompt the delivery checker uses to pre-review a PR deliverable once CI is green.',
  ...
  'settings.taskhunter.visual.field.inputHistoryScope': 'Input history scope',
  'settings.taskhunter.visual.field.inputHistoryScopeDescription': 'Choose whether submitted prompts are recalled across all projects connected to this runtime or only in the current session.',
  'settings.taskhunter.visual.section.inputHistoryScopeAria': 'Input history scope',
  'settings.taskhunter.visual.option.inputHistoryScope.global.label': 'All projects',
  'settings.taskhunter.visual.option.inputHistoryScope.session.label': 'Current session',
  'settings.taskhunter.visual.field.inputHistoryLimit': 'Prompts to remember',
  'settings.taskhunter.visual.field.inputHistoryLimitDescription': 'Lowering this number removes older prompts from your history.',
  'settings.taskhunter.visual.field.inputHistoryLimitAria': 'Prompts to remember',
  ...
  'settings.page.integrations.description': 'Connect GitHub and Linear so TaskHunter can work with your issues and pull requests.',
} as const;
