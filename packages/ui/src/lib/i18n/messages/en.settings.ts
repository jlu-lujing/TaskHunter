...
export const settingsDict = {
  ...
  'settings.taskhunter.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
