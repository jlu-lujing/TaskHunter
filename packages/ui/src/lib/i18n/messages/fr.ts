...
export const dict = {
  ...
  'board.claim.action': 'Démarrer une session pour cette tâche',
  'board.eval.approve': 'Approuver et lancer',
  ...
  'board.claim.toast.sessionStarted': 'Session démarrée',
  ...
  'board.claim.toast.startFailed': 'Échec du démarrage de la session',
