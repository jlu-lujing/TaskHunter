...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez TaskHunter pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'TaskHunter installé',
  ...
  'board.title': 'Kanban',
  'board.back': 'Retour',
  'board.newTask': 'Nouvelle tâche',
  'board.loading': 'Chargement du tableau…',
  'board.retry': 'Réessayer',
  'board.filter.allProjects': 'Tous les projets',
  'board.filterProject': 'Filtrer par projet',
  'board.column.empty': 'Aucune tâche',
  'board.status.backlog': 'Backlog',
  'board.status.planning': 'Planification',
  'board.status.queued': 'En file',
  'board.status.running': 'En cours',
  'board.status.checking': 'Vérification',
  'board.status.merging': 'Fusion en cours',
  'board.status.inProgress': 'En cours',
  'board.status.review': 'En revue',
  'board.status.done': 'Terminée',
  'board.status.blocked': 'Bloqué',
  'board.card.sessions': 'Sessions liées',
  'board.card.menu.open': 'Détails de la carte',
  'board.card.menu.edit': 'Modifier la carte',
  'board.card.menu.openSession': 'Ouvrir la session worker',
  'board.card.menu.openPr': 'Ouvrir la pull request',
  'board.card.menu.initRepo': 'Initialiser le dépôt Git',
  'board.card.menu.initRepoCreated': 'Dépôt Git initialisé',
  'board.card.menu.initRepoAlready': 'Déjà un dépôt Git',
  'board.card.menu.initRepoFailed': 'Échec de l’initialisation du dépôt Git',
  'board.card.menu.moveToBacklog': 'Déplacer vers Backlog',
  'board.card.menu.moveToPlanning': 'Déplacer vers Planification',
  'board.card.menu.deleteFailed': 'Échec de la suppression de la carte',
  'board.card.moveBack': 'Reculer d’une colonne',
  'board.card.moveForward': 'Avancer d’une colonne',
  'board.dialog.titleCreate': 'Nouvelle tâche',
  'board.dialog.titleEdit': 'Modifier la tâche',
  'board.dialog.field.title': 'Titre',
  'board.dialog.field.titlePlaceholder': 'À faire ?',
  'board.dialog.field.description': 'Description',
  'board.dialog.field.descriptionPlaceholder': 'Détails vus par l’agent de code',
  'board.dialog.field.project': 'Projet',
  'board.dialog.field.noProject': 'Sans projet',
  'board.dialog.field.status': 'Statut',
  'board.dialog.field.labels': 'Étiquettes',
  'board.dialog.field.labelsPlaceholder': 'séparées par des virgules',
  'board.dialog.create': 'Créer',
  'board.dialog.save': 'Enregistrer',
  'board.dialog.delete': 'Supprimer',
  'board.dialog.cancel': 'Annuler',
  'board.eval.planTitle': 'Plan de lancement',
  'board.eval.running': 'Évaluation…',
  'board.eval.failed': 'Évaluation échouée',
  'board.eval.retry': 'Réévaluer',
  'board.planning.approve': 'Approuver et mettre en file',
  'board.checking.verify': 'Vérification de la livraison',
  'board.eval.deliverable.pr': 'Livrable : PR',
  'board.eval.deliverable.report': 'Livrable : rapport',
  'board.eval.review.human': 'Revue humaine',
  'board.eval.review.green': 'Fusion auto si CI verte',
  'board.settings.action': 'Paramètres du tableau',
  'board.settings.title': 'Paramètres du tableau',
  'board.settings.model': 'Modèle de distribution',
  'board.settings.modelUnset': 'Aucun modèle par défaut — les sessions utilisent celui du sélecteur',
  'board.settings.modelHint': 'Utilisé pour l’évaluation et les sessions distribuées',
  'board.settings.modelClear': 'effacer',
  'board.settings.maxConcurrent': 'Tâches simultanées max.',
  'board.settings.automation': 'Automatisation',
  'board.settings.automation.plan': 'Approuver avant lancement',
  'board.settings.automation.auto': 'Lancer après évaluation',
  'board.settings.automationHint': 'Applicable aux cartes prêtes sans plan de lancement propre',
  'board.settings.budgets': 'Budgets de reprise',
  'board.settings.checkRetries': 'Auto-réparation vérif.',
  'board.settings.mergeRetries': 'Rebase de fusion',
  'board.settings.maxAttempts': 'Réessai distribution',
  'board.review.merge': 'Fusionner la PR',
  'board.review.accept': 'Valider et terminer',
  'board.review.return': 'Ramener à Prêt',
  'board.queue.queued': 'En file',
  'board.queue.merging': 'Fusion en cours',
  'board.queue.rebasing': 'Rebase en cours',
  'board.detail.sessions': 'Sessions',
  'board.detail.noSessions': 'Aucune session',
  'board.detail.open': 'Ouvrir',
  'board.detail.close': 'Fermer',
  'board.detail.edit': 'Modifier',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': 'À propos de TaskHunter',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur TaskHunter auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans TaskHunter. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter doit accéder à ce dossier.',
  ...
  'aboutDialog.taskHunterVersionLabel': 'Version TaskHunter {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état TaskHunter, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans TaskHunter',
  ...
  'header.actions.openAppMenu': 'Menu de TaskHunter',
  'header.actions.openAppMenuAria': 'Ouvrir le menu TaskHunter',
  ...
  'chat.textSelection.actions.askTaskHunter': 'Au fait…',
  'chat.textSelection.title.askTaskHunter': 'Ouvrir un brouillon BTW avec la sélection',
  ...
  'projects.sharedTrust.description': '{path} dans ce dépôt définit des commandes qui s\'exécutent sur cette machine. Faites-leur confiance une fois, et TaskHunter ne redemandera que si elles changent.',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez TaskHunter depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez TaskHunter',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs TaskHunter locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution TaskHunter.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur TaskHunter',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si TaskHunter ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de TaskHunter — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres TaskHunter et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur TaskHunter auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur TaskHunter ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas TaskHunter. Vérifiez que l\'adresse pointe vers un serveur TaskHunter.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas TaskHunter. Vérifiez que l\'adresse pointe vers un serveur TaskHunter.',
  ...
  'startup.initRecovery.description': 'TaskHunter n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de TaskHunter...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Attendez un peu et actualisez, ou exécutez : taskhunter update',
  'updateDialog.error.signatureRejected': 'La mise à jour téléchargée a été rejetée : sa signature de code ne correspond pas à cette installation. Cela signifie généralement que la copie en cours n’a pas été installée depuis une version officielle signée. Installez TaskHunter depuis une version officielle, puis relancez la mise à jour.',
  'updateDialog.error.updaterDisabled': 'Le programme de mise à jour s’est arrêté après une installation échouée. Quittez TaskHunter, rouvrez-le, puis réessayez la mise à jour.',
  'updateDialog.error.restartFailed': 'Impossible de redémarrer pour installer la mise à jour.',
  'updateDialog.error.restartUnavailable': 'L’installation de la mise à jour nécessite l’application de bureau TaskHunter.',
  'mobileUpdate.toast.available.title': 'Mise à jour TaskHunter disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez TaskHunter ouvert.',
  ...
  'mobile.connect.welcome.title': 'Se connecter à TaskHunter',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe TaskHunter',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion TaskHunter.',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur TaskHunter.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve TaskHunter, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge TaskHunter. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à TaskHunter — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’TaskHunter. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute TaskHunter mais n’est pas compatible avec cette version de l’application. Mettez TaskHunter à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur TaskHunter à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez TaskHunter à jour sur le serveur, puis réessayez.',
