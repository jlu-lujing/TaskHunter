...
export const dict = {
  ...
  'board.claim.toast.sendTaskFailed': 'Échec de l’envoi de la tâche à la session',
  'board.claim.toast.startFailed': 'Échec du démarrage de la session',
  'board.claim.error.noProject': 'Cette tâche nécessite d’abord un projet',
  'board.claim.error.noModelSelected': 'Aucun modèle par défaut — choisissez-en un dans les réglages',
