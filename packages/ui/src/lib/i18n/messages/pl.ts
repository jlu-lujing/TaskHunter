...
export const dict: Record<I18nKey, string> = {
  ...
  'board.claim.toast.sendTaskFailed': 'Nie udało się wysłać zadania do sesji',
  'board.claim.toast.startFailed': 'Nie udało się rozpocząć sesji',
  'board.claim.error.noProject': 'To zadanie wymaga najpierw wyboru projektu',
  'board.claim.error.noModelSelected': 'Brak domyślnego modelu — wybierz go w Ustawieniach',
