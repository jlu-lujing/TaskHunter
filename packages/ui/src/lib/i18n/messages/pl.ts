...
export const dict: Record<I18nKey, string> = {
  ...
  'board.claim.action': 'Rozpocznij sesję dla tego zadania',
  'board.eval.approve': 'Zatwierdź i uruchom',
  ...
  'board.claim.toast.sessionStarted': 'Sesja rozpoczęta',
  ...
  'board.claim.toast.startFailed': 'Nie udało się rozpocząć sesji',
