...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj TaskHunter, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'TaskHunter został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z TaskHunter',
  ...
  'mobile.connect.password.placeholder': 'Hasło TaskHunter',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia TaskHunter.',
  ...
  'mobile.connect.relay.badge': 'przez TaskHunter Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem TaskHunter.',
  ...
  'sessions.sidebar.header.actions.board': 'Kanban',
  'board.title': 'Tablica Kanban',
  'board.back': 'Wstecz',
  'board.newTask': 'Nowe zadanie',
  'board.loading': 'Ładowanie tablicy…',
  'board.retry': 'Ponów',
  'board.filter.allProjects': 'Wszystkie projekty',
  'board.filterProject': 'Filtruj po projekcie',
  'board.column.empty': 'Brak zadań',
  'board.status.backlog': 'Backlog',
  'board.status.planning': 'Planowanie',
  'board.status.queued': 'W kolejce',
  'board.status.running': 'Uruchomione',
  'board.status.checking': 'Sprawdzanie',
  'board.status.merging': 'Scalanie',
  'board.status.inProgress': 'W toku',
  'board.status.review': 'Review',
  'board.status.done': 'Zrobione',
  'board.status.blocked': 'Zablokowane',
  'board.card.sessions': 'Powiązane sesje',
  'board.card.menu.open': 'Szczegóły karty',
  'board.card.menu.edit': 'Edytuj kartę',
  'board.card.menu.openSession': 'Otwórz sesję workera',
  'board.card.menu.openPr': 'Otwórz pull request',
  'board.card.menu.initRepo': 'Zainicjuj repozytorium Git',
  'board.card.menu.initRepoCreated': 'Repozytorium Git zainicjowane',
  'board.card.menu.initRepoAlready': 'To już repozytorium Git',
  'board.card.menu.initRepoFailed': 'Nie udało się zainicjować repozytorium Git',
  'board.card.menu.moveToBacklog': 'Przenieś do Backlogu',
  'board.card.menu.moveToPlanning': 'Przenieś do Planowania',
  'board.card.menu.deleteFailed': 'Nie udało się usunąć karty',
  'board.card.moveBack': 'Przesuń wstecz',
  'board.card.moveForward': 'Przesuń dalej',
  'board.dialog.titleCreate': 'Nowe zadanie',
  'board.dialog.titleEdit': 'Edytuj zadanie',
  'board.dialog.field.title': 'Tytuł',
  'board.dialog.field.titlePlaceholder': 'Co zrobić?',
  'board.dialog.field.description': 'Opis',
  'board.dialog.field.descriptionPlaceholder': 'Szczegóły widoczne dla agenta kodującego',
  'board.dialog.field.project': 'Projekt',
  'board.dialog.field.noProject': 'Bez projektu',
  'board.dialog.field.status': 'Status',
  'board.dialog.field.labels': 'Etykiety',
  'board.dialog.field.labelsPlaceholder': 'oddzielone przecinkami',
  'board.dialog.create': 'Utwórz',
  'board.dialog.save': 'Zapisz',
  'board.dialog.delete': 'Usuń',
  'board.dialog.cancel': 'Anuluj',
  'board.eval.planTitle': 'Plan startowy',
  'board.eval.running': 'Ocena…',
  'board.eval.failed': 'Ocena nie powiodła się',
  'board.eval.retry': 'Oceń ponownie',
  'board.planning.approve': 'Zatwierdź i zakoleguj',
  'board.checking.verify': 'Sprawdzanie dostarczenia',
  'board.eval.deliverable.pr': 'Dostarczenie: PR',
  'board.eval.deliverable.report': 'Dostarczenie: raport',
  'board.eval.review.human': 'Recenzja człowieka',
  'board.eval.review.green': 'Auto-scalenie po zielonym CI',
  'board.settings.action': 'Ustawienia tablicy',
  'board.settings.title': 'Ustawienia tablicy',
  'board.settings.model': 'Model uruchomień',
  'board.settings.modelUnset': 'Brak domyślnego modelu — sesje używają wartości selektora',
  'board.settings.modelHint': 'Używany do oceny i sesji tablicy',
  'board.settings.modelClear': 'wyczyść',
  'board.settings.maxConcurrent': 'Maks. jednoczesnych zadań',
  'board.settings.automation': 'Automatyzacja',
  'board.settings.automation.plan': 'Zatwierdź przed startem',
  'board.settings.automation.auto': 'Startuj automatycznie po ocenie',
  'board.settings.automationHint': 'Dotyczy kart trafiających do Ready bez własnego planu',
  'board.settings.budgets': 'Budżety ponowień',
  'board.settings.checkRetries': 'Samonaprawa kontroli',
  'board.settings.mergeRetries': 'Rebase scalania',
  'board.settings.maxAttempts': 'Ponowienia uruchomień',
  'board.review.merge': 'Scal PR',
  'board.review.accept': 'Zaakceptuj i zakończ',
  'board.review.return': 'Odeślij do Ready',
  'board.queue.queued': 'W kolejce',
  'board.queue.merging': 'Scalanie',
  'board.queue.rebasing': 'Rebase',
  'board.detail.sessions': 'Sesje',
  'board.detail.noSessions': 'Brak sesji',
  'board.detail.open': 'Otwórz',
  'board.detail.close': 'Zamknij',
  'board.detail.edit': 'Edytuj',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': 'O TaskHunter',
  ...
  'chat.textSelection.actions.askTaskHunter': 'A tak przy okazji…',
  'chat.textSelection.title.askTaskHunter': 'Otwórz szkic BTW z zaznaczonym tekstem',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia TaskHunter.',
  ...
  'onboarding.chooser.title': 'Witaj w TaskHunter',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli TaskHunter nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień TaskHunter i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera TaskHunter aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer TaskHunter, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji TaskHunter. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia TaskHunter, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj TaskHunter na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim TaskHunter. Zweryfikuj czy adres wskazuje na serwer TaskHunter.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia TaskHunter. Zweryfikuj czy adres wskazuje na serwer TaskHunter.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer TaskHunter pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj TaskHunter na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'TaskHunter nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan TaskHunter, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.taskHunterVersionLabel': 'Wersja TaskHunter {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer TaskHunter, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest TaskHunter, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest TaskHunter. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do TaskHunter — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami TaskHunter',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w TaskHunter. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu TaskHunter',
  'header.actions.openAppMenuAria': 'Otwórz menu TaskHunter',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po TaskHunter.',
  ...
  'taskHunterLogo.aria.logo': 'Logo TaskHunter',
  ...
  'projects.sharedTrust.description': '{path} w tym repozytorium definiuje polecenia uruchamiane na tym komputerze. Zaufaj raz, a TaskHunter zapyta ponownie tylko wtedy, gdy się zmienią.',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz TaskHunter z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj TaskHunter',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: taskhunter update',
  'updateDialog.error.signatureRejected': 'Pobrana aktualizacja została odrzucona: jej podpis kodu nie pasuje do tej instalacji. Zwykle oznacza to, że uruchomiona kopia nie pochodzi z oficjalnego podpisanego wydania. Zainstaluj TaskHunter z oficjalnego wydania i zaktualizuj ponownie.',
  'updateDialog.error.updaterDisabled': 'Aktualizator zatrzymał się po nieudanej instalacji. Zamknij TaskHunter, otwórz go ponownie i spróbuj zaktualizować jeszcze raz.',
  'updateDialog.error.restartFailed': 'Nie udało się uruchomić ponownie, aby zainstalować aktualizację.',
  'updateDialog.error.restartUnavailable': 'Instalacja aktualizacji wymaga aplikacji desktopowej TaskHunter.',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja TaskHunter',
  ...
  'updateDialog.header.updating': 'Aktualizowanie TaskHunter...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw TaskHunter otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce TaskHunter — zainstaluj je, aby zacząć.',
  ...
  'settings.taskhunter.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.taskhunter.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.taskhunter.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.taskhunter.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.taskhunter.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.taskhunter.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.taskhunter.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.taskhunter.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
