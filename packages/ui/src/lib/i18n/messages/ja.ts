...
export const dict: Record<I18nKey, string> = {
  ...
  'board.claim.toast.sendTaskFailed': 'セッションへのタスク送信に失敗しました',
  'board.claim.toast.startFailed': 'セッション開始に失敗',
  'board.claim.error.noProject': 'このタスクはプロジェクトの選択が必要です',
  'board.claim.error.noModelSelected': '利用可能なデフォルトモデルがありません—設定で選択してください',
