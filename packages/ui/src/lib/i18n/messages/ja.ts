...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'TaskHunterをインストールしてすぐにアクセス',
  'pwa.installPrompt.action': 'インストール',
  'pwa.installPrompt.dismiss': '閉じる',
  'pwa.installPrompt.started': 'インストールを開始しました',
  'pwa.installPrompt.installed': 'TaskHunterをインストールしました',
  ...
  'mobile.connect.password.placeholder': 'TaskHunter のパスワード',
  ...
  'mobile.connect.relay.badge': 'TaskHunter Relay 経由',
  ...
  'mobile.connect.error.unreachable': 'その TaskHunter サーバーに接続できませんでした。',
  ...
  'mobile.connect.scan.invalid': 'その QR コードは TaskHunter の接続コードではありません。',
  ...
  'sessions.sidebar.header.actions.board': 'かんばん',
  'board.title': 'かんばん',
  'board.back': '戻る',
  'board.newTask': '新規タスク',
  'board.loading': 'かんばんを読み込み中…',
  'board.retry': '再試行',
  'board.filter.allProjects': 'すべてのプロジェクト',
  'board.filterProject': 'プロジェクトで絞り込み',
  'board.column.empty': 'タスクなし',
  'board.status.backlog': 'バックログ',
  'board.status.planning': 'プラン',
  'board.status.queued': 'キュー待ち',
  'board.status.running': '実行中',
  'board.status.checking': 'チェック',
  'board.status.merging': 'マージ中',
  'board.status.inProgress': '進行中',
  'board.status.review': 'レビュー中',
  'board.status.done': '完了',
  'board.status.blocked': 'ブロック済み',
  'board.card.sessions': '関連セッション',
  'board.card.menu.open': 'カードの詳細',
  'board.card.menu.edit': 'カードを編集',
  'board.card.menu.openSession': 'ワーカーセッションを開く',
  'board.card.menu.openPr': 'プルリクエストを開く',
  'board.card.menu.initRepo': 'Git リポジトリを初期化',
  'board.card.menu.initRepoCreated': 'Git リポジトリを初期化しました',
  'board.card.menu.initRepoAlready': 'すでに Git リポジトリです',
  'board.card.menu.initRepoFailed': 'Git リポジトリの初期化に失敗しました',
  'board.card.menu.moveToBacklog': 'バックログへ移動',
  'board.card.menu.moveToPlanning': 'プランニングへ移動',
  'board.card.menu.deleteFailed': 'カードを削除できませんでした',
  'board.card.moveBack': '前の列へ',
  'board.card.moveForward': '次の列へ',
  'board.dialog.titleCreate': '新規タスク',
  'board.dialog.titleEdit': 'タスクを編集',
  'board.dialog.field.title': 'タイトル',
  'board.dialog.field.titlePlaceholder': 'やることは？',
  'board.dialog.field.description': '説明',
  'board.dialog.field.descriptionPlaceholder': 'コーディングエージェントが見る詳細',
  'board.dialog.field.project': 'プロジェクト',
  'board.dialog.field.noProject': 'プロジェクトなし',
  'board.dialog.field.status': '状態',
  'board.dialog.field.labels': 'ラベル',
  'board.dialog.field.labelsPlaceholder': 'カンマ区切り',
  'board.dialog.create': '作成',
  'board.dialog.save': '保存',
  'board.dialog.delete': '削除',
  'board.dialog.cancel': 'キャンセル',
  'board.eval.planTitle': '起動プラン',
  'board.eval.running': '評価中…',
  'board.eval.failed': '評価に失敗',
  'board.eval.retry': '再評価',
  'board.planning.approve': '承認してキュー投入',
  'board.checking.verify': '成果物を検証中',
  'board.eval.deliverable.pr': '成果物: PR',
  'board.eval.deliverable.report': '成果物: レポート',
  'board.eval.review.human': '人手レビュー',
  'board.eval.review.green': 'CI 成功で自動マージ',
  'board.settings.action': 'ボード設定',
  'board.settings.title': 'ボード設定',
  'board.settings.model': 'ディスパッチモデル',
  'board.settings.modelUnset': 'デフォルトモデル未設定 — セッションはピッカーのデフォルトを使用',
  'board.settings.modelHint': 'ボード評価とディスパッチセッションで使用',
  'board.settings.modelClear': 'クリア',
  'board.settings.maxConcurrent': '最大同時タスク数',
  'board.settings.automation': '自動化',
  'board.settings.automation.plan': '開始前に承認',
  'board.settings.automation.auto': '評価後に自動開始',
  'board.settings.automationHint': '個別プランなしで Ready に入ったカードに適用',
  'board.settings.budgets': 'リトライ予算',
  'board.settings.checkRetries': 'チェック自己修復',
  'board.settings.mergeRetries': 'マージrebase',
  'board.settings.maxAttempts': 'ディスパッチ再試行',
  'board.review.merge': 'PR をマージ',
  'board.review.accept': '承認して完了',
  'board.review.return': 'Ready に戻す',
  'board.queue.queued': 'キュー待ち',
  'board.queue.merging': 'マージ中',
  'board.queue.rebasing': 'リベース中',
  'board.detail.sessions': 'セッション',
  'board.detail.noSessions': 'セッションはまだありません',
  'board.detail.open': '開く',
  'board.detail.close': '閉じる',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': 'TaskHunterについて',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'このアプリが接続している TaskHunter サーバーはウォークスルー API に応答しませんでした。つまりアプリより古いバージョンです。サーバーを 1.18 以降に更新してから再読み込みしてください。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} は TaskHunter が動いているマシン上にあり、そこへの接続を開けませんでした。あなたのマシンの内容はここには表示されません。',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは TaskHunter を動かしているマシン上で動作しています。開くにはデスクトップアプリが必要です。',
  ...
  'contextPanel.browser.trustNotice': 'ここで開かれたページはTaskHunterへの完全なアクセス権を持ちます — 検査とスクリーンショットに必要です。信頼できるサイトのみを開いてください: 悪意のあるページがデータを読み取ったりあなたの代わりに行動したりする可能性があります。',
  ...
  'filesView.editor.binaryFileDescription': 'このファイルはバイナリのため、TaskHunterでは編集できません。別のアプリで開くにはダウンロードしてください。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter がこのフォルダにアクセスする必要があります。',
  ...
  'aboutDialog.taskHunterVersionLabel': 'TaskHunter バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'TaskHunterの状態、OpenCodeの状態、ディレクトリ、プロジェクトが含まれます。',
  ...
  'helpDialog.description': 'これらのキーボードショートカットを使ってTaskHunterを効率的に操作できます',
  ...
  'header.actions.openAppMenu': 'TaskHunterメニュー',
  'header.actions.openAppMenuAria': 'TaskHunterメニューを開く',
  ...
  'chat.textSelection.actions.askTaskHunter': 'ところで…',
  'chat.textSelection.title.askTaskHunter': '選択したテキストでBTWの下書きを開く',
  ...
  'sessionAuth.error.networkDescription': 'UI セッションを確認できませんでした。ローカルネットワーク上の別のデバイスから TaskHunter を開く場合は、デスクトップアプリで Desktop Network Access を有効にし、設定に表示される LAN アドレスを使用してください。',
  ...
  'sessionAuth.locked.unlockTitle': 'TaskHunterのロックを解除',
  ...
  'desktopHostSwitcher.description': 'ローカルとリモートのTaskHunterサーバーを切り替えます',
  ...
  'multiRun.window.description': 'TaskHunterマルチランウィンドウ。',
  ...
  'onboarding.chooser.title': 'TaskHunterへようこそ',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'TaskHunterがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'OpenCodeはTaskHunterの中核です — インストールして開始しましょう。',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'TaskHunter設定に保存し、OpenCode設定を再読み込みします。',
  ...
  'onboarding.remoteConnection.description': '接続するTaskHunterサーバーのアドレスを入力します。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'ヒント: URLがTaskHunterサーバーを指しているか確認するか、サーバー管理者に問い合わせてください。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'このインスタンスは異なるバージョンのTaskHunterを実行しています。接続は可能ですが、正常に動作しない場合は両方のアプリを更新してください。',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'サーバーはTaskHunterを実行していますが、このアプリバージョンと互換性がありません。サーバーのTaskHunterを更新してから再試行してください。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'サーバーは応答しましたが、TaskHunterを実行していません。アドレスがTaskHunterサーバーを指していることを確認してください。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」のサーバーはTaskHunterを実行していません。アドレスがTaskHunterサーバーを指していることを確認してください。',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'サーバーの更新が必要',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」のTaskHunterサーバーはこのアプリバージョンと互換性がありません。サーバーのTaskHunterを更新してから再試行してください。',
  ...
  'startup.initRecovery.description': 'TaskHunterが初期化を完了できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  ...
  'updateDialog.header.updating': 'TaskHunterを更新中...',
  ...
  'updateDialog.error.takingLonger': '更新に予想以上に時間がかかっています。しばらく待ってから更新するか、次を実行: taskhunter update',
  'updateDialog.error.signatureRejected': 'ダウンロードした更新は拒否されました。コード署名がこのインストールと一致しません。通常は、実行中のコピーが公式の署名済みリリースからインストールされていないことを意味します。公式リリースから TaskHunter をインストールし直してから、もう一度更新してください。',
  'updateDialog.error.updaterDisabled': 'インストールに失敗したため、アップデーターが停止しました。TaskHunter を終了して開き直し、更新をやり直してください。',
  'updateDialog.error.restartFailed': '更新をインストールするための再起動に失敗しました。',
  'updateDialog.error.restartUnavailable': '更新のインストールには TaskHunter デスクトップアプリが必要です。',
  'mobileUpdate.toast.available.title': 'TaskHunterの更新があります',
  ...
  'opencodeUpdate.toast.upgrading.description': 'TaskHunterを開いたままにしてください。',
  ...
  'taskHunterLogo.aria.logo': 'TaskHunterロゴ',
