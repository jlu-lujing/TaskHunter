...
export const dict: Record<I18nKey, string> = {
  ...
  'board.claim.action': 'このタスクのセッションを開始',
  'board.eval.approve': '承認して開始',
  ...
  'board.claim.toast.sessionStarted': 'セッションを開始しました',
  ...
  'board.claim.toast.startFailed': 'セッション開始に失敗',
