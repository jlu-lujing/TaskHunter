...
export const dict: Record<I18nKey, string> = {
  ...
  'board.claim.toast.sendTaskFailed': '세션으로 작업 전송 실패',
  'board.claim.toast.startFailed': '세션 시작 실패',
  'board.claim.error.noProject': '이 작업은 프로젝트를 먼저 선택해야 합니다',
  'board.claim.error.noModelSelected': '기본 모델이 없습니다—설정에서 선택하세요',
