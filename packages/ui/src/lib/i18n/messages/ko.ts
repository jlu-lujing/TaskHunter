...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 TaskHunter를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'TaskHunter가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'TaskHunter에 연결',
  ...
  'mobile.connect.password.placeholder': 'TaskHunter 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 TaskHunter 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'TaskHunter Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 TaskHunter 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.header.actions.board': '칸반',
  'board.title': '칸반',
  'board.back': '돌아가기',
  'board.newTask': '새 작업',
  'board.loading': '칸반 보드 로딩 중…',
  'board.retry': '다시 시도',
  'board.filter.allProjects': '모든 프로젝트',
  'board.filterProject': '프로젝트로 필터',
  'board.column.empty': '작업 없음',
  'board.status.backlog': '백로그',
  'board.status.planning': '계획',
  'board.status.queued': '대기 열',
  'board.status.running': '실행 중',
  'board.status.checking': '검사',
  'board.status.merging': '병합 중',
  'board.status.inProgress': '진행 중',
  'board.status.review': '리뷰 중',
  'board.status.done': '완료',
  'board.status.blocked': '차단됨',
  'board.card.sessions': '연결된 세션',
  'board.card.menu.open': '카드 세부 정보',
  'board.card.menu.edit': '카드 편집',
  'board.card.menu.openSession': '워커 세션 열기',
  'board.card.menu.openPr': '풀 리퀘스트 열기',
  'board.card.menu.initRepo': 'Git 저장소 초기화',
  'board.card.menu.initRepoCreated': 'Git 저장소를 초기화했습니다',
  'board.card.menu.initRepoAlready': '이미 Git 저장소입니다',
  'board.card.menu.initRepoFailed': 'Git 저장소 초기화 실패',
  'board.card.menu.moveToBacklog': '백로그로 이동',
  'board.card.menu.moveToPlanning': '플래닝으로 이동',
  'board.card.menu.deleteFailed': '카드 삭제 실패',
  'board.card.moveBack': '이전 열로',
  'board.card.moveForward': '다음 열로',
  'board.dialog.titleCreate': '새 작업',
  'board.dialog.titleEdit': '작업 편집',
  'board.dialog.field.title': '제목',
  'board.dialog.field.titlePlaceholder': '무엇을 할까요?',
  'board.dialog.field.description': '설명',
  'board.dialog.field.descriptionPlaceholder': '코딩 에이전트가 보는 세부 정보',
  'board.dialog.field.project': '프로젝트',
  'board.dialog.field.noProject': '프로젝트 없음',
  'board.dialog.field.status': '상태',
  'board.dialog.field.labels': '라벨',
  'board.dialog.field.labelsPlaceholder': '쉼표로 구분',
  'board.dialog.create': '생성',
  'board.dialog.save': '저장',
  'board.dialog.delete': '삭제',
  'board.dialog.cancel': '취소',
  'board.eval.planTitle': '실행 계획',
  'board.eval.running': '평가 중…',
  'board.eval.failed': '평가 실패',
  'board.eval.retry': '재평가',
  'board.planning.approve': '승인 및 대기',
  'board.checking.verify': '산출물 검증 중',
  'board.eval.deliverable.pr': '산출물: PR',
  'board.eval.deliverable.report': '산출물: 보고서',
  'board.eval.review.human': '사람 리뷰',
  'board.eval.review.green': 'CI 통과 시 자동 병합',
  'board.settings.action': '보드 설정',
  'board.settings.title': '보드 설정',
  'board.settings.model': '디스패치 모델',
  'board.settings.modelUnset': '기본 모델 없음 — 세션은 피커 기본값 사용',
  'board.settings.modelHint': '보드 평가 및 디스패치 세션에 사용',
  'board.settings.modelClear': '지우기',
  'board.settings.maxConcurrent': '최대 동시 작업',
  'board.settings.automation': '자동화',
  'board.settings.automation.plan': '실행 전 승인 필요',
  'board.settings.automation.auto': '평가 후 자동 실행',
  'board.settings.automationHint': '자체 계획 없이 Ready로 들어온 카드에 적용',
  'board.settings.budgets': '재시도 예산',
  'board.settings.checkRetries': '검사 자가 복구',
  'board.settings.mergeRetries': '병합 리베이스',
  'board.settings.maxAttempts': '디스패치 재시도',
  'board.review.merge': 'PR 병합',
  'board.review.accept': '수락 후 완료',
  'board.review.return': 'Ready로 반환',
  'board.queue.queued': '대기 중',
  'board.queue.merging': '병합 중',
  'board.queue.rebasing': '리베이스 중',
  'board.detail.sessions': '세션',
  'board.detail.noSessions': '세션이 없습니다',
  'board.detail.open': '열기',
  'board.detail.close': '닫기',
  'board.detail.edit': '편집',
  ...
  'sessions.sidebar.footer.actions.aboutTaskHunter': 'TaskHunter 정보',
  ...
  'contextRail.surface.graph.description': '커밋 그래프와 커밋별 작업',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 TaskHunter 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 은(는) TaskHunter가 실행 중인 컴퓨터에 있으며, 그곳으로의 연결을 열지 못했습니다. 이 화면에는 사용자 컴퓨터의 내용이 표시되지 않습니다.',
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 TaskHunter가 실행 중인 컴퓨터에 있습니다. 열려면 데스크톱 앱이 필요합니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 TaskHunter에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 TaskHunter에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'TaskHunter에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.taskHunterVersionLabel': 'TaskHunter 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'TaskHunter 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 TaskHunter를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'TaskHunter 메뉴',
  'header.actions.openAppMenuAria': 'TaskHunter 메뉴 열기',
  ...
  'chat.textSelection.actions.askTaskHunter': '그런데…',
  'chat.textSelection.title.askTaskHunter': '선택한 텍스트로 BTW 초안 열기',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 TaskHunter를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'TaskHunter 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 TaskHunter 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'TaskHunter 멀티런 창.',
  ...
  'onboarding.chooser.title': 'TaskHunter에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'TaskHunter가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 TaskHunter의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'TaskHunter 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 TaskHunter 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 TaskHunter 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 TaskHunter 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 TaskHunter가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 TaskHunter를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 TaskHunter가 실행 중이 아닙니다. 주소가 TaskHunter 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 TaskHunter가 실행 중이 아닙니다. 주소가 TaskHunter 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 TaskHunter 서버가 이 앱 버전과 호환되지 않습니다. 서버의 TaskHunter를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'TaskHunter 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'TaskHunter 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `taskhunter update`를 실행하세요.',
  'updateDialog.error.signatureRejected': '다운로드한 업데이트가 거부되었습니다. 코드 서명이 이 설치본과 일치하지 않습니다. 보통 실행 중인 복사본이 공식 서명 릴리스에서 설치되지 않았다는 뜻입니다. 공식 릴리스에서 TaskHunter를 설치한 뒤 다시 업데이트하세요.',
  'updateDialog.error.updaterDisabled': '설치에 실패하여 업데이터가 중지되었습니다. TaskHunter를 종료했다가 다시 열고 업데이트를 재시도하세요.',
  'updateDialog.error.restartFailed': '업데이트를 설치하기 위한 재시작에 실패했습니다.',
  'updateDialog.error.restartUnavailable': '업데이트 설치에는 TaskHunter 데스크톱 앱이 필요합니다.',
  'mobileUpdate.toast.available.title': 'TaskHunter 업데이트 사용 가능',
  ...
  'opencodeUpdate.toast.upgrading.description': 'TaskHunter를 열어 두세요.',
  ...
  'taskHunterLogo.aria.logo': 'TaskHunter 로고',
