...
const DEVICE_SEED_KEY_PREFIX = 'taskhunter.deviceSeeded.v1:';
...
const SETTINGS_MIRROR_KEY_PREFIX = 'taskhunter.settingsMirror.v2:';const MAX_SETTINGS_MIRROR_RUNTIMES = 5;
