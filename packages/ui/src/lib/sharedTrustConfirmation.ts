 ...
 *
 * Commands in `<repo>/.taskhunter/project.json` run on this machine, and a
...
import { getProjectSetup, updateProjectSetup, type ProjectRef, type ProjectSetup } from './taskhunterConfig';
