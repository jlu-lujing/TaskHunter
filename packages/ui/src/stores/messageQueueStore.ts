...
/**
 * Who delivers the queue. Web, desktop, and mobile talk to a TaskHunter
...
export const messageQueueUpdatedEventSchema = z.object({
    type: z.literal('taskhunter:message-queue.updated'),
...
/** `taskhunter:message-queue.updated` broadcast → projection. */
