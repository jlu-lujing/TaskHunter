...
const MarkdownImageThumbnail: React.FC<{
  ...
  return (
    <button
      ...
      onClick={openPreview}
      data-taskhunter-markdown-image-action="true"
      data-taskhunter-markdown-image-source={candidate.source}
      data-taskhunter-markdown-image-filename={candidate.filename}
    >
      <span className="flex h-[72px] w-[100px] items-center justify-center overflow-hidden rounded-lg border border-border/40 bg-muted/10">
        {image.url && image.status !== 'error' ? (
          <img
            ...
            data-taskhunter-markdown-image="true"
            data-taskhunter-markdown-image-thumbnail="true"
            data-taskhunter-markdown-image-state={image.status}
          />
        ) : (
      ...
      <span
        ...
        title={candidate.filename}
        data-taskhunter-markdown-image-caption="true"
      >
...
export const MarkdownImageGallery: React.FC<{
  ...
  return (
    <div
      ...
      data-taskhunter-markdown-image-gallery="true"
    >
