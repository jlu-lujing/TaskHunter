 ...
 * payloads must be parsed for paths, and TaskHunter's own file tree marks an
...
/** Data type marking a drag that started in TaskHunter's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-taskhunter-file-path';
