  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running TaskHunter. Verify the address points to an TaskHunter server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The TaskHunter server at "${host || 'unknown'}" is not compatible with this app version. Update TaskHunter on the server, then try again.`,
