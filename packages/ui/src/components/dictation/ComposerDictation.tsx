...
export const ComposerDictation: React.FC<ComposerDictationProps> = ({
    ...
    // The dictation server (WebSocket + STT worker) lives in the TaskHunter
    ...
    React.useEffect(() => {
        ...
        window.addEventListener('taskhunter:dictation-toggle', onToggle);
        return () => window.removeEventListener('taskhunter:dictation-toggle', onToggle);
