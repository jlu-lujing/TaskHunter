      ...
      <div className="space-y-3">
        ...
        >
          <Input
            ...
            placeholder={t('settings.taskhunter.desktopPassword.field.passwordPlaceholder')}
            disabled={isLoading || isSaving}
            required={draftValue}
          ...
          <Button
            ...
            aria-label={t(showPassword ? 'settings.taskhunter.desktopPassword.actions.hidePassword' : 'settings.taskhunter.desktopPassword.actions.showPassword')}
