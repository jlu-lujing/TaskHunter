...
/**
 * Which TaskHunter capabilities agents are given.
 *
 ...
 */
export const TaskHunterToolsSettings: React.FC = () => {
  const { t } = useI18n();
  ...
  return (
    <SettingsSection title={t('settings.taskhunter.tools.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsCheckboxRow
          settingsItem="sessions.agent-control-tool"
          checked={agentControlToolEnabled}
          onChange={handleAgentControlToolChange}
          label={t('settings.taskhunter.tools.field.agentControlTool')}
          ariaLabel={t('settings.taskhunter.tools.field.agentControlToolAria')}
          info={t('settings.taskhunter.tools.field.agentControlToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.taskhunter.tools.field.agentWebTool')}
          ariaLabel={t('settings.taskhunter.tools.field.agentWebToolAria')}
          info={t('settings.taskhunter.tools.field.agentWebToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.taskhunter.tools.field.agentMemoryTool')}
          ariaLabel={t('settings.taskhunter.tools.field.agentMemoryToolAria')}
          info={t('settings.taskhunter.tools.field.agentMemoryToolInfo')}
        />
        ) : null}
      </div>
    </SettingsSection>
