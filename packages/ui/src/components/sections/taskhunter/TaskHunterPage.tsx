...
import { TaskHunterVisualSettings } from './TaskHunterVisualSettings';
...
import type { TaskHunterSection } from './types';
...
interface TaskHunterPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: TaskHunterSection;
}

export const TaskHunterPage: React.FC<TaskHunterPageProps> = ({ section }) => {
    const { t } = useI18n();
    ...
    return (
        <SettingsPageLayout
            ...
            showSaveStatus
            className="taskhunter-page-body"
        >
...
const GeneralSectionContent: React.FC = () => {
    ...
    return (
        <>
            ...
            {!isVSCode && <OpenCodeCliSettings />}
            {!isVSCode && <TaskHunterToolsSettings />}
            <TaskHunterVisualSettings visibleSettings={[
                'fileEditorKeymap',
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <TaskHunterVisualSettings visibleSettings={[
        'theme',
