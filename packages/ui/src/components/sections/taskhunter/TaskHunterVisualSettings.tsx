...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string; descriptionKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.taskhunter.visual.option.themeMode.system',
        descriptionKey: 'settings.taskhunter.visual.option.themeMode.system.description',
    },
    {
        value: 'light',
        labelKey: 'settings.taskhunter.visual.option.themeMode.light',
        descriptionKey: 'settings.taskhunter.visual.option.themeMode.light.description',
    },
    {
        value: 'dark',
        labelKey: 'settings.taskhunter.visual.option.themeMode.dark',
        descriptionKey: 'settings.taskhunter.visual.option.themeMode.dark.description',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.taskhunter.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.taskhunter.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.taskhunter.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.taskhunter.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.taskhunter.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.taskhunter.visual.option.diffLayout.sideBySide.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.taskhunter.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.taskhunter.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.taskhunter.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.taskhunter.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'TaskHunter - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.taskhunter.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.taskhunter.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.taskhunter.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.taskhunter.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.taskhunter.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.taskhunter.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.taskhunter.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.taskhunter.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.taskhunter.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.taskhunter.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];

type PwaInstallNameWindow = Window & {
    __TASKHUNTER_SET_PWA_INSTALL_NAME__?: (value: string) => string;
    __TASKHUNTER_SET_PWA_ORIENTATION__?: (value: 'system' | 'portrait' | 'landscape') => 'system' | 'portrait' | 'landscape';
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.taskhunter.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.taskhunter.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.taskhunter.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.taskhunter.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.taskhunter.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.taskhunter.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.taskhunter.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.taskhunter.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.taskhunter.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.taskhunter.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.taskhunter.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.taskhunter.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.taskhunter.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.taskhunter.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.taskhunter.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.taskhunter.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.taskhunter.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.taskhunter.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.taskhunter.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.taskhunter.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.taskhunter.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.taskhunter.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.taskhunter.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.taskhunter.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.taskhunter.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.taskhunter.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.taskhunter.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.taskhunter.visual.option.weekStart.sunday.label',
    },
];
...
const FOLLOW_UP_BEHAVIOR_OPTIONS: Option<FollowUpBehavior>[] = [
    {
        id: 'steer',
        labelKey: 'settings.taskhunter.visual.option.followUpBehavior.steer.label',
    },
    {
        id: 'queue',
        labelKey: 'settings.taskhunter.visual.option.followUpBehavior.queue.label',
    },
];
...
const LARGE_TEXT_PASTE_BEHAVIOR_OPTIONS: Option<LargeTextPasteBehavior>[] = [
    {
        id: 'ask',
        labelKey: 'settings.taskhunter.visual.option.largeTextPaste.ask.label',
    },
    {
        id: 'attach',
        labelKey: 'settings.taskhunter.visual.option.largeTextPaste.attach.label',
    },
    {
        id: 'inline',
        labelKey: 'settings.taskhunter.visual.option.largeTextPaste.inline.label',
    },
];
...
const INPUT_HISTORY_SCOPE_OPTIONS: Option<InputHistoryScope>[] = [
    {
        id: 'global',
        labelKey: 'settings.taskhunter.visual.option.inputHistoryScope.global.label',
    },
    {
        id: 'session',
        labelKey: 'settings.taskhunter.visual.option.inputHistoryScope.session.label',
    },
];
...
const WINDOW_CONTROLS_POSITION_OPTIONS: Array<{ id: DesktopWindowControlsPosition; labelKey: string }> = [
    { id: 'left', labelKey: 'settings.taskhunter.desktopNetwork.option.windowControlsLeft' },
    { id: 'right', labelKey: 'settings.taskhunter.desktopNetwork.option.windowControlsRight' },
];

const WINDOW_CONTROLS_STYLE_OPTIONS: Array<{ id: DesktopWindowControlsStyle; labelKey: string }> = [
    { id: 'classic', labelKey: 'settings.taskhunter.desktopNetwork.option.windowControlsClassic' },
    { id: 'traffic-lights', labelKey: 'settings.taskhunter.desktopNetwork.option.windowControlsTrafficLights' },
];

interface TaskHunterVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const TaskHunterVisualSettings: React.FC<TaskHunterVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const dockBadgeSupported = React.useMemo(
        () => isDesktopShell() && typeof window !== 'undefined'
            && (window as unknown as { __TASKHUNTER_PLATFORM__?: string }).__TASKHUNTER_PLATFORM__ === 'darwin',
        [],
    );
    ...
    const handleFileViewerPreviewChange = React.useCallback((enabled: boolean) => {
        ...
        window.dispatchEvent(new CustomEvent('taskhunter:file-viewer-preview-mode-changed', { detail: { enabled } }));
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.taskhunter.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.taskhunter.visual.option.weekStart.auto.label');
    ...
    const applyPwaInstallName = React.useCallback(async (value: string) => {
        ...
        if (typeof win.__TASKHUNTER_SET_PWA_INSTALL_NAME__ === 'function') {
            const resolved = win.__TASKHUNTER_SET_PWA_INSTALL_NAME__(persistedValue);
    ...
    const applyPwaOrientation = React.useCallback(async (value: 'system' | 'portrait' | 'landscape') => {
        ...
        if (typeof win.__TASKHUNTER_SET_PWA_ORIENTATION__ === 'function') {
            const resolved = win.__TASKHUNTER_SET_PWA_ORIENTATION__(normalized);
    ...
    const scrollbarSetting = shouldShow('scrollbars') ? (
        <SettingsCheckboxRow
            ...
            label={t('settings.taskhunter.visual.field.alwaysShowScrollbars')}
            info={t('settings.taskhunter.visual.field.alwaysShowScrollbarsHint')}
    ...
    return (
        <div className="space-y-0">
                ...
                {hasAppearanceSettings && (
                    <div className="space-y-0">
                        {hasThemeSettings && (
                            <SettingsSection title={t('settings.taskhunter.visual.section.colorModeAndTheme')} divider={false}>
                                <SettingsTwoColumn>
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.colorMode')}>
                                    ...
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsStackedField
                                            label={t('settings.taskhunter.visual.field.lightTheme')}
                                            settingsItem="appearance.light-theme"
                                        >
                                            <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                                <SelectTrigger aria-label={t('settings.taskhunter.visual.field.selectLightThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.taskhunter.visual.field.selectThemePlaceholder')}>
                                                        {selectedLightTheme
                                        ...
                                        <SettingsStackedField
                                            label={t('settings.taskhunter.visual.field.darkTheme')}
                                            settingsItem="appearance.dark-theme"
                                        >
                                            <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                                <SelectTrigger aria-label={t('settings.taskhunter.visual.field.selectDarkThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.taskhunter.visual.field.selectThemePlaceholder')}>
                                                        {selectedDarkTheme
                                        ...
                                        <div className="flex items-center gap-2 pt-1">
                                            ...
                                            >
                                                ...
                                                {themesReloading ? t('settings.taskhunter.visual.actions.reloadingThemes') : t('settings.taskhunter.visual.actions.reloadThemes')}
                                            </button>
                                            <SettingsInfoHint>
                                                {t('settings.taskhunter.visual.field.themeImportInfoTooltip')}
                                            </SettingsInfoHint>
                                        </div>
                                    </div>
                                </SettingsTwoColumn>
                                ...
                                {dockBadgeSupported && (
                                    <SettingsInset settingsItem="appearance.dock-badge">
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.taskhunter.visual.field.dockBadge')}
                                            info={t('settings.taskhunter.visual.field.dockBadgeHint')}
                                            ariaLabel={t('settings.taskhunter.visual.field.dockBadge')}
                                        />
                                    </SettingsInset>
                                )}
                        ...
                        {showWindowControlsPositionSetting && (
                            <SettingsSection
                                title={t('settings.taskhunter.desktopNetwork.field.windowControls')}
                                info={t('settings.taskhunter.desktopNetwork.field.windowControlsPositionDescription')}
                                divider={hasThemeSettings}
                            >
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.desktopNetwork.field.windowControlsPosition')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.taskhunter.desktopNetwork.field.windowControlsPositionAria')}
                                        />
                                    </SettingsStackedField>
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.desktopNetwork.field.windowControlsStyle')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.taskhunter.desktopNetwork.field.windowControlsStyleAria')}
                                        />
                                    </SettingsStackedField>
                                </SettingsTwoColumn>
                            </SettingsSection>
                        ...
                        {hasLocalizationSettings && (
                            <SettingsSection title={t('settings.taskhunter.visual.section.localization')}>
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                    ...
                                    {(shouldShow('timeFormat') || shouldShow('weekStart')) && (
                                        <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                            {shouldShow('timeFormat') && (
                                                <SettingsStackedField
                                                    label={t('settings.taskhunter.visual.field.timeFormat')}
                                                ...
                                                >
                                                    <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.taskhunter.visual.field.selectTimeFormatAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            ...
                                            {shouldShow('weekStart') && (
                                                <SettingsStackedField
                                                    label={t('settings.taskhunter.visual.field.weekStartsOn')}
                                                ...
                                                >
                                                    <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.taskhunter.visual.field.selectWeekStartAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            <SettingsSection title={t('settings.taskhunter.visual.section.appInstall')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>

                            {showPwaInstallNameSetting && (
                                <SettingsFieldRow
                                    label={t('settings.taskhunter.visual.field.installAppName')}
                                    info={t('settings.taskhunter.visual.field.installAppNameHint')}
                                ...
                                >
                                    <Input
                                        ...
                                        maxLength={64}
                                        aria-label={t('settings.taskhunter.visual.field.pwaInstallAppNameAria')}
                                    />
                                    <Button size="sm"
                                        type="button"
                                        variant="ghost"
                                        ...
                                        aria-label={t('settings.taskhunter.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <SettingsFieldRow
                                    label={t('settings.taskhunter.visual.field.installOrientation')}
                                    description={t('settings.taskhunter.visual.field.installOrientationHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.taskhunter.visual.field.pwaInstallOrientationAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.taskhunter.visual.field.selectOrientationPlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.taskhunter.visual.actions.resetInstallOrientationAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <SettingsFieldRow
                                    label={t('settings.taskhunter.visual.field.mobileKeyboardMode')}
                                    info={t('settings.taskhunter.visual.field.mobileKeyboardModeHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.taskhunter.visual.field.mobileKeyboardModeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.taskhunter.visual.field.selectMobileKeyboardModePlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.taskhunter.visual.actions.resetMobileKeyboardModeAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                ...
                {/* --- Density & type --- */}
                {hasLayoutSettings && (
                    <SettingsSection title={t('settings.taskhunter.visual.section.densityAndType')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.interfaceFont')}
                                        settingsItem="appearance.interface-font-size"
                                        controlClassName="w-full"
                                    >
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.taskhunter.visual.field.selectInterfaceFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.taskhunter.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.codeFont')}
                                        controlClassName="w-full"
                                    >
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.taskhunter.visual.field.selectCodeFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.taskhunter.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                        ...
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') || shouldShow('editorFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.interfaceFontSize')}
                                        controlClassName="w-full"
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            <NumberInput
                                                ...
                                                aria-label={t('settings.taskhunter.visual.field.fontSizePercentageAria')}
                                            />
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.taskhunter.visual.actions.resetFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.terminalFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.taskhunter.visual.actions.resetTerminalFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('editorFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.editorFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.taskhunter.visual.actions.resetEditorFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                        ...
                        {shouldShow('spacing') || (shouldShow('inputBarOffset') && isMobile) ? (
                            <SettingsTwoColumn>
                                {shouldShow('spacing') && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.spacingDensity')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.taskhunter.visual.actions.resetSpacingAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('inputBarOffset') && isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.taskhunter.visual.field.inputBarOffset')}
                                        info={t('settings.taskhunter.visual.field.inputBarOffsetTooltip')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.taskhunter.visual.actions.resetInputBarOffsetAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                ...
                {hasNavigationSettings && (
                    <SettingsSection title={t('settings.taskhunter.visual.section.navigation')} contentClassName="space-y-4">
                        {shouldShow('fileEditorKeymap') && (
                            <SettingsControlGroup
                                title={t('settings.taskhunter.visual.field.fileEditorKeymap')}
                                settingsItem="appearance.file-editor-keymap"
                            >
                                <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.field.fileEditorKeymap')}>
                                    {(['default', 'vim'] as const).map((keymap) => (
                                        <SettingsRadioOption
                                            key={keymap}
                                            selected={fileEditorKeymap === keymap}
                                            onSelect={() => setFileEditorKeymap(keymap)}
                                            label={t(`settings.taskhunter.visual.option.fileEditorKeymap.${keymap}`)}
                                            ariaLabel={t(`settings.taskhunter.visual.option.fileEditorKeymap.${keymap}`)}
                                        />
                                    ))}
                                </SettingsRadioGroup>
                            </SettingsControlGroup>
                        ...
                        <div className={SETTINGS_OPTION_STACK_CLASS}>
                            {shouldShow('autoSaveEnabled') && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.taskhunter.visual.field.autoSaveEnabled')}
                                    ariaLabel={t('settings.taskhunter.visual.field.autoSaveEnabledAria')}
                                    info={t('settings.taskhunter.visual.field.autoSaveEnabledInfo')}
                                    settingsItem="appearance.auto-save-enabled"
                                />
                            )}
                            {showTerminalShellSetting && (
                                <SettingsStackedField
                                    label={t('settings.taskhunter.visual.field.terminalShell')}
                                    info={t('settings.taskhunter.visual.field.terminalShellHint')}
                                ...
                                >
                                    <Select value={terminalShell} onValueChange={(value) => { if (isTerminalShell(value)) setTerminalShell(value); }}>
                                        <SelectTrigger aria-label={t('settings.taskhunter.visual.field.terminalShellAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="auto">{t('settings.taskhunter.visual.option.terminalShell.auto')}</SelectItem>
                            ...
                            {showTerminalShellSetting && terminalShellSupportsLogin && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.taskhunter.visual.field.terminalLoginShell')}
                                    ariaLabel={t('settings.taskhunter.visual.field.terminalLoginShell')}
                            ...
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.taskhunter.visual.field.terminalQuickKeys')}
                                    ariaLabel={t('settings.taskhunter.visual.field.terminalQuickKeysAria')}
                                    settingsItem="appearance.terminal-quick-keys"
                                    info={t('settings.taskhunter.visual.field.terminalQuickKeysTooltip', {
                        ...
                        {shouldShow('sessionTabs') && !isVSCode && !isMobile && (
                            <SettingsControlGroup
                                title={t('settings.taskhunter.visual.field.sessionTabsGroup')}
                                settingsItem="appearance.session-tabs"
                            >
                                <SettingsCheckboxRow
                                    checked={sessionTabsEnabled}
                                    onChange={setSessionTabsEnabled}
                                    label={t('settings.taskhunter.visual.field.sessionTabs')}
                                    ariaLabel={t('settings.taskhunter.visual.field.sessionTabsAria')}
                                    info={t('settings.taskhunter.visual.field.sessionTabsInfo')}
                                />
                            </SettingsControlGroup>
                        )}
                    </SettingsSection>
                ...
                {hasBehaviorSettings && (
                    <>
                        {showBehaviorDisplaySettings && (
                            <SettingsSection
                                title={t('settings.taskhunter.visual.section.chatDisplay')}
                                divider={behaviorSectionDivider}
                                contentClassName="space-y-6"
                            >
                                {shouldShow('chatRenderMode') && (
                                    <SettingsControlGroup
                                        title={t('settings.taskhunter.visual.section.chatRenderMode')}
                                        settingsItem="chat.render-mode"
                                    >
                                        <div role="radiogroup" aria-label={t('settings.taskhunter.visual.section.chatRenderModeAria')} className="grid w-full max-w-[26rem] grid-cols-1 gap-3 @xl:grid-cols-2">
                                        ...
                                        <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.activityDefaultAria')}>
                                            {ACTIVITY_RENDER_MODE_OPTIONS.map((option) => (
                                                <SettingsRadioOption
                                                    ...
                                                    label={tUnsafe(option.labelKey)}
                                                    ariaLabel={t('settings.taskhunter.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                />
                                            ))}
                                        </SettingsRadioGroup>
                                    </SettingsControlGroup>
                        ...
                        {showTransportSection && (
                            <SettingsSection
                                title={t('settings.taskhunter.visual.section.messageStreamTransport')}
                            ...
                            >
                                <SettingsChipGroup
                                    ...
                                    aria-label={t('settings.taskhunter.visual.section.messageStreamTransport')}
                                />
                                {(() => {
                        ...
                        {showBehaviorMessageOptions && (
                            <SettingsSection
                                title={t('settings.taskhunter.visual.section.chatMessageOptions')}
                            ...
                            >
                                ...
                                <SettingsTwoColumn className="lg:gap-y-6">
                                    {shouldShow('userMessageRendering') && (
                                        <SettingsControlGroup title={t('settings.taskhunter.visual.section.userMessageRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.userMessageRenderingAria')}>
                                                {USER_MESSAGE_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.taskhunter.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <SettingsControlGroup title={t('settings.taskhunter.visual.section.mermaidRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.mermaidRenderingAria')}>
                                                {MERMAID_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.taskhunter.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <SettingsControlGroup title={t('settings.taskhunter.visual.section.diffLayout')}>
                                            <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.diffLayoutAria')}>
                                                {DIFF_LAYOUT_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.taskhunter.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('followUpBehavior') && (
                                        <SettingsControlGroup
                                            title={t('settings.taskhunter.visual.section.followUpBehavior')}
                                            settingsItem="chat.follow-up-behavior"
                                        >
                                            <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.followUpBehaviorAria')}>
                                                {FOLLOW_UP_BEHAVIOR_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.taskhunter.visual.field.followUpBehaviorAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('inputHistoryScope') && (
                                        <SettingsControlGroup
                                            title={t('settings.taskhunter.visual.field.inputHistoryScope')}
                                            info={t('settings.taskhunter.visual.field.inputHistoryScopeDescription')}
                                            settingsItem="chat.input-history-scope"
                                        >
                                            <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.section.inputHistoryScopeAria')}>
                                    ...
                                    {shouldShow('inputHistoryLimit') && (
                                        <SettingsControlGroup
                                            title={t('settings.taskhunter.visual.field.inputHistoryLimit')}
                                            description={t('settings.taskhunter.visual.field.inputHistoryLimitDescription')}
                                        ...
                                        >
                                            <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                                <NumberInput
                                                    ...
                                                    aria-label={t('settings.taskhunter.visual.field.inputHistoryLimitAria')}
                                                />
                                                <span className={SETTINGS_NUMBER_UNIT_CLASS}>
                                                    {t('settings.taskhunter.visual.field.inputHistoryLimitUnit')}
                                                </span>
                                            </div>
                                        </SettingsControlGroup>
                                    )}
                        ...
                        {showBehaviorFeatureCheckboxes && (
                            <>
                                {shouldShow('expandedTools') && (
                                    <SettingsSection
                                        title={t('settings.taskhunter.visual.section.showToolsOpenedByDefault')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.taskhunter.visual.field.bash')}
                                            ariaLabel={t('settings.taskhunter.visual.field.showExpandedBashToolsAria')}
                                        />
                                        <SettingsCheckboxRow
                                            checked={showExpandedEditTools}
                                            onChange={handleShowExpandedEditToolsChange}
                                            label={t('settings.taskhunter.visual.field.editTools')}
                                            ariaLabel={t('settings.taskhunter.visual.field.showExpandedEditToolsAria')}
                                        />
                                    </SettingsSection>
                                )}
                                <SettingsSection
                                    title={t('settings.taskhunter.visual.section.sessionAssistance')}
                                ...
                                >
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.draftStartersVisible')}
                                        ariaLabel={t('settings.taskhunter.visual.field.draftStartersVisibleAria')}
                                    ...
                                    />
                                        {shouldShow('sessionAssist') && (
                                            <>
                                                <SettingsCheckboxRow
                                                    ...
                                                    label={t('settings.taskhunter.visual.field.sessionRecap')}
                                                    ariaLabel={t('settings.taskhunter.visual.field.sessionRecapAria')}
                                                    settingsItem="chat.session-recap"
                                                />
                                                <SettingsCheckboxRow
                                                    checked={sessionSuggestionEnabled}
                                                    onChange={setSessionSuggestionEnabled}
                                                    label={t('settings.taskhunter.visual.field.sessionSuggestion')}
                                                    ariaLabel={t('settings.taskhunter.visual.field.sessionSuggestionAria')}
                                        ...
                                        {shouldShow('subagentReadOnlyBanner') && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.taskhunter.visual.field.allowPromptingSubagentSessions')}
                                                ariaLabel={t('settings.taskhunter.visual.field.allowPromptingSubagentSessionsAria')}
                                ...
                                {shouldShow('sessionGoal') && !isVSCode && (
                                    <SettingsSection
                                        title={t('settings.taskhunter.visual.goal.sectionTitle')}
                                        info={t('settings.taskhunter.visual.goal.description')}
                                        contentClassName={SETTINGS_OPTION_STACK_CLASS}
                                    >
                                        <SettingsCheckboxRow
                                            checked={sessionGoalEnabled}
                                            onChange={setSessionGoalEnabled}
                                            label={t('settings.taskhunter.visual.field.sessionGoal')}
                                            ariaLabel={t('settings.taskhunter.visual.field.sessionGoalAria')}
                                        ...
                                        <div data-settings-item="chat.session-goal-budget" className="flex items-center gap-2">
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.taskhunter.visual.goal.budgetLabel')}
                                                ariaLabel={t('settings.taskhunter.visual.goal.budgetAria')}
                                            />
                                ...
                                {shouldShow('reasoning') && (
                                    <SettingsSection
                                        title={t('settings.taskhunter.visual.section.reasoning')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.taskhunter.visual.field.showReasoningTraces')}
                                            ariaLabel={t('settings.taskhunter.visual.field.showReasoningTracesAria')}
                                        ...
                                        {showReasoningTraces && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.taskhunter.visual.field.collapsibleThinkingBlocks')}
                                                ariaLabel={t('settings.taskhunter.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                        )}
                                    </SettingsSection>
                                )}
                                <SettingsSection
                                    title={t('settings.taskhunter.visual.section.streaming')}
                                ...
                                >
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.streamingAutoFollow')}
                                        ariaLabel={t('settings.taskhunter.visual.field.streamingAutoFollowAria')}
                                        info={t('settings.taskhunter.visual.field.streamingAutoFollowInfo')}
                                ...
                                <SettingsSection
                                    title={t('settings.taskhunter.visual.section.messageAppearance')}
                                ...
                                {shouldShow('collapsibleUserMessages') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.collapsibleUserMessages')}
                                        ariaLabel={t('settings.taskhunter.visual.field.collapsibleUserMessagesAria')}
                                ...
                                {shouldShow('stickyUserHeader') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.stickyUserHeader')}
                                        ariaLabel={t('settings.taskhunter.visual.field.stickyUserHeaderAria')}
                                ...
                                {shouldShow('promptNavigatorEnabled') && !isVSCode && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.promptNavigatorEnabled')}
                                        ariaLabel={t('settings.taskhunter.visual.field.promptNavigatorEnabledAria')}
                                ...
                                {shouldShow('wideChatLayout') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.wideChatLayout')}
                                        ariaLabel={t('settings.taskhunter.visual.field.wideChatLayoutAria')}
                                ...
                                {shouldShow('splitAssistantMessageActions') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.showSplitAssistantMessageActions')}
                                        ariaLabel={t('settings.taskhunter.visual.field.showSplitAssistantMessageActionsAria')}
                                        settingsItem="chat.inline-assistant-actions"
                                        info={t('settings.taskhunter.visual.field.showSplitAssistantMessageActionsTooltip')}
                                    />
                                )}
                                ...
                                {shouldShow('codeBlockLineWrap') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.codeBlockLineWrap')}
                                        ariaLabel={t('settings.taskhunter.visual.field.codeBlockLineWrapAria')}
                                ...
                                <SettingsSection
                                    title={t('settings.taskhunter.visual.section.toolsAndFiles')}
                                ...
                                {shouldShow('showToolFileIcons') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.showToolFileIcons')}
                                        ariaLabel={t('settings.taskhunter.visual.field.showToolFileIconsAria')}
                                ...
                                {shouldShow('showTurnChangedFiles') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.showTurnChangedFiles')}
                                        ariaLabel={t('settings.taskhunter.visual.field.showTurnChangedFilesAria')}
                                ...
                                {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.showDotfiles')}
                                        ariaLabel={t('settings.taskhunter.visual.field.showDotfilesAria')}
                                ...
                                {shouldShow('fileViewerPreview') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.defaults.field.openFilesPreview')}
                                        ariaLabel={t('settings.taskhunter.defaults.field.openFilesPreviewAria')}
                                    />
                                )}
                                </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.taskhunter.visual.section.composer')}
                                ...
                                {shouldShow('persistDraft') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.persistDraftMessages')}
                                        ariaLabel={t('settings.taskhunter.visual.field.persistDraftMessagesAria')}
                                ...
                                {!isMobile && shouldShow('inputSpellcheck') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.taskhunter.visual.field.enableSpellcheckInTextInputs')}
                                        ariaLabel={t('settings.taskhunter.visual.field.enableSpellcheckInTextInputsAria')}
                                ...
                                {shouldShow('largeTextPaste') && (
                                    <SettingsControlGroup
                                        title={t('settings.taskhunter.visual.field.largeTextPaste')}
                                        description={t('settings.taskhunter.visual.field.largeTextPasteHint')}                                        settingsItem="chat.large-text-paste"
                                    >
                                        <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.field.largeTextPasteAria')}>
                                            {LARGE_TEXT_PASTE_BEHAVIOR_OPTIONS.map((option) => (
                                                <SettingsRadioOption
                                                    ...
                                                    label={tUnsafe(option.labelKey)}
                                                    ariaLabel={t('settings.taskhunter.visual.field.largeTextPasteOptionAria', { option: tUnsafe(option.labelKey) })}
                                                />
                                            ))}
                                        </SettingsRadioGroup>
                                     </SettingsControlGroup>
                                ...
                                {shouldShow('enterToSend') && (
                                    <SettingsControlGroup
                                        title={t('settings.taskhunter.visual.field.enterToSend')}
                                        description={t('settings.taskhunter.visual.field.enterToSendHint')}
                                        settingsItem="chat.enter-to-send"
                                    >
                                        <SettingsRadioGroup aria-label={t('settings.taskhunter.visual.field.enterToSend')}>
                                            <SettingsRadioOption
                                                selected={enterSendSelected}
                                                onSelect={() => handleEnterToSendChange(true)}
                                                label={t('settings.taskhunter.visual.option.enterToSend.enter.label')}
                                                ariaLabel={t('settings.taskhunter.visual.option.enterToSend.enter.label')}
                                            />
                                            <SettingsRadioOption
                                                selected={!enterSendSelected}
                                                onSelect={() => handleEnterToSendChange(false)}
                                                label={t('settings.taskhunter.visual.option.enterToSend.modifier.label')}
                                                ariaLabel={t('settings.taskhunter.visual.option.enterToSend.modifier.label')}
                                            />
                                        </SettingsRadioGroup>
                                    </SettingsControlGroup>
                                )}
                ...
                {shouldShow('reportUsage') && (
                    <SettingsSection title={t('settings.taskhunter.visual.section.privacy')}>
                        <SettingsCheckboxRow
                            checked={reportUsage}
                            onChange={handleReportUsageChange}
                            label={t('settings.taskhunter.visual.field.sendAnonymousUsageReports')}
                            info={t('settings.taskhunter.visual.field.sendAnonymousUsageReportsHint')}
                            ariaLabel={t('settings.taskhunter.visual.field.sendAnonymousUsageReportsAria')}
