...
// mounts (see the `__taskhunterEnsureNerdFonts` hook in index.html). Wait for
...
const ensureNerdFonts = (): Promise<void> => {
  ...
  const loader = (window as typeof window & { __taskhunterEnsureNerdFonts?: () => Promise<void> }).__taskhunterEnsureNerdFonts;
