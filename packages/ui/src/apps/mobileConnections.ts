...
const MOBILE_CONNECTIONS_STORAGE_KEY = 'taskhunter.mobile.connections.v1';
const MOBILE_SECURE_STORAGE_PREFIX = 'taskhunter.mobile.';
const MOBILE_DEVICE_ID_STORAGE_KEY = 'taskhunter.mobile.deviceId';
  ...
  const redeemPairingConnection = React.useCallback(async (payload: PairingConnectionPayload) => {
    ...
    try {
      ...
      const redeemBody = JSON.stringify({
        ...
        clientLabel: 'TaskHunter Mobile',
        clientKind: 'mobile',
        deviceName: 'TaskHunter Mobile',
  ...
  const submitPassword = React.useCallback(async (password: string) => {
    ...
    try {
      ...
      const loginInit = {
        ...
        body: JSON.stringify({ password, trustDevice: true, issueClientToken: true, clientLabel: 'TaskHunter Mobile', clientKind: 'mobile', devicePlatform: mobileDevicePlatform(), dedupeKey: mobileClientDedupeKey() }),
      };
