...
description: TaskHunter'ı hızlıca başlatın ve iş için doğru uygulamayı seçin.
---
...
2. TaskHunter CLI'yı yükleyin. Tek satırlık komut için [Install](/install/) sayfasına bakın.
3. `taskhunter --ui-password be-creative-here` komutunu çalıştırın.
...
Tarayıcınızda TaskHunter oturum listesini görmelisiniz. Yüklendiyse çalışıyordur.
