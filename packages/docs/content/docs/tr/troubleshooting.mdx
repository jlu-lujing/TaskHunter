...
## TaskHunter komutu kapanıyor ya da başlamıyor

- Node.js sürümünün `>=22` olduğunu doğrulayın
- `taskhunter --version` çalıştırın
- Gerekirse en son CLI'yı yeniden kurun

## Web arayüzüne ulaşılamıyor

- Sunucu günlüklerini `taskhunter logs` ile kontrol edin
...
- TaskHunter sunucusunun çalıştığını doğrulayın
