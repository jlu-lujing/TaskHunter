...
Integration, sahip olduğunuz bir aboneliği kullanarak TaskHunter'a bir provider ekleyen küçük bir eklentidir. Bunları **Settings → Integrations** altında yönetirsiniz.
...
Cursor, Cursor planınıza dahil modelleri TaskHunter'da kullanılabilir hale getirir.
