...
**Clear cookies** ve **Clear cached data** yalnızca bu panele uygulanır. TaskHunter oturumunuza ve diğer pencerelere dokunulmaz.
...
Ayrıca baktığı şeyin bir resmini proje içindeki `.taskhunter/screenshots/` klasörüne kaydedip yanıtında size gösterebilir. Öncesi ve sonrası karşılaştırmasını mümkün kılan şey budur ve dosya sonrasında bir pull request'e eklemek için orada kalır.

Tarayıcı eylemleri **TaskHunter Web tool**'dur. Bunu **Settings → General → TaskHunter Tools** altında ayrı ayrı açıp kapatabilirsiniz.
