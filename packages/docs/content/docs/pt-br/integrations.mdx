...
Uma integração é um pequeno plugin que adiciona um provedor ao TaskHunter usando uma assinatura que você já tem. Você as gerencia em **Settings → Integrations**.
...
O Cursor torna disponíveis no TaskHunter os modelos incluídos no seu plano Cursor.
