...
## O comando TaskHunter encerra ou não inicia

- confirme o Node.js `>=22`
- execute `taskhunter --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `taskhunter logs`
...
- confirme que o servidor do TaskHunter está em execução
