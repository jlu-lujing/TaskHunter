---
title: Reverse Proxy
description: Configure TaskHunter correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run TaskHunter behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
