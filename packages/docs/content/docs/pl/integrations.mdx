...
Integracja to mała wtyczka, która dodaje dostawcę do TaskHunter na podstawie subskrypcji, którą już masz. Zarządzasz nimi w **Settings → Integrations**.
...
Cursor udostępnia w TaskHunter modele zawarte w Twoim planie Cursor.
