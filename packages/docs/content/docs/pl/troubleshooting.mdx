...
## Polecenie TaskHunter kończy się lub nie uruchamia

- upewnij się, że Node.js `>=22`
- uruchom `taskhunter --version`
- w razie potrzeby zainstaluj ponownie najnowsze CLI

## Webowy interfejs jest nieosiągalny

- sprawdź logi serwera poleceniem `taskhunter logs`
...
- upewnij się, że serwer TaskHunter działa
