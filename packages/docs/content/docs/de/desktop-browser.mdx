...
**Cookies löschen** und **Zwischengespeicherte Daten löschen** gelten allein für dieses Panel. Deine TaskHunter-Sitzung und andere Fenster bleiben unberührt.
...
Er kann außerdem ein Bild dessen, was er sieht, in `.taskhunter/screenshots/` in deinem Projekt speichern und es dir in seiner Antwort zeigen. Genau das macht ein Vorher-Nachher möglich, und die Datei bleibt danach liegen, um sie an einen Pull Request zu hängen.

Die Browser-Aktionen sind das **TaskHunter-Web-Werkzeug**, das sich unter **Einstellungen → Allgemein → TaskHunter-Werkzeuge** einzeln ein- und ausschalten lässt.
