...
Die Desktop-App kann unter **Settings → TaskHunter → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du TaskHunter nicht per CLI starten.

## Anbieter installieren

TaskHunter startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → TaskHunter → Tunnel**.
