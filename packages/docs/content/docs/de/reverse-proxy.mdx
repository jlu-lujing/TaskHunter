---
title: Reverse Proxy
description: Konfigurieren Sie TaskHunter korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn TaskHunter hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass TaskHunter direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn TaskHunter Antworten bereits komprimiert.
...
- TaskHunter direkt im LAN erreichbar
...
- TaskHunter komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von TaskHunter von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
