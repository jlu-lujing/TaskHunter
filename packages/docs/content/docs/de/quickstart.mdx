---
title: Schnellstart
description: Starte TaskHunter schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das TaskHunter-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
3. Führe `taskhunter --ui-password be-creative-here` aus.
...
Du solltest die TaskHunter-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
