---
title: Quickstart
description: Start TaskHunter quickly and pick the right app for the task.
---
...
2. Install the TaskHunter CLI (see [Install](/install/) for the one-line command).
...
You should see the TaskHunter session list in your browser. If it loads, you're up and running.
