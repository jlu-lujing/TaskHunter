...
Cuando el agente se detiene y la sesión queda en silencio un momento, TaskHunter:
...
- El bucle del objetivo corre en el servidor de TaskHunter, no en tu pestaña del navegador. Cierra la pestaña, bloquea el teléfono — el agente sigue trabajando y recibirás una notificación cuando el objetivo termine. El servidor (app de escritorio o proceso `taskhunter`) debe seguir en marcha.
