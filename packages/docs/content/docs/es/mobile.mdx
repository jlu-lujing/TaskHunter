...
description: Instala la app de TaskHunter en iOS o Android y conéctala a tu servidor.
---

# Apps móviles y PWA

TaskHunter tiene apps nativas para iPhone y Android, para que puedas seguir sesiones, responder a los agentes y gestionar el trabajo desde tu teléfono, en casa por Wi-Fi o desde cualquier lugar a través del [Private Relay](/es/private-relay/).

## Instala la app

- **iPhone/iPad** — únete a la [beta de TestFlight](https://testflight.apple.com/join/5ek6GU1E)
- **Android** — descarga el APK de la [última release](https://github.com/jlu-lujing/TaskHunter/releases/latest)

## Conéctala a tu servidor

1. En la computadora donde se ejecuta TaskHunter, abre **Settings → Remote Instances → Conectarse a este servidor** y pulsa **Añadir un dispositivo**.
...
En **Settings → TaskHunter**, unas cuantas opciones ajustan la experiencia móvil e instalada: el nombre de la app instalada, la orientación de la pantalla y el comportamiento del teclado en pantalla.
