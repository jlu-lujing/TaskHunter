...
## El comando TaskHunter se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `taskhunter --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `taskhunter logs`
...
- confirma que el servidor de TaskHunter está en marcha
