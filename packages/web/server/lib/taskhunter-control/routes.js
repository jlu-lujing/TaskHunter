...
export const registerTaskHunterControlRoutes = (app, { controlService }) => {
  app.post('/api/taskhunter/control', express.json({ limit: '1mb' }), async (req, res) => {
    ...
    try {
      ...
      const controlError = asControlError(error, 'TaskHunter control action failed');
