...
import { applyConnectAttemptTimeout } from '@taskhunter/web/server/lib/network-defaults.js';
  ...
  <body>
    <div class="stack">
      <svg width="120" height="120" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="TaskHunter loading icon">
        <g stroke="var(--splash-stroke)" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="50" cy="50" r="29.3" stroke-width="6.6" fill="var(--splash-face-fill)"/>
        <g stroke-width="6.6">
...
const dispatchMenuAction = (action) => {
  ...
  if (action === 'zoom-in' || action === 'zoom-out' || action === 'zoom-reset') {
    dispatchDomEventToWindow(target, 'taskhunter:zoom', action);
    return;
  }
