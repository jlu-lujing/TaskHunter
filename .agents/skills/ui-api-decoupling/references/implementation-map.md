...
- `packages/web/server/lib/opencode/core-routes.js`: installs TaskHunter route families.
...
Explicit TaskHunter routes must register before the generic `/api/*` OpenCode proxy.
